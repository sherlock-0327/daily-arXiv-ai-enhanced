...
- [physics.flu-dyn](#physics.flu-dyn) [Total: 22]
...
### [20] [DiMo-GUI: Advancing Test-time Scaling in GUI Grounding via Modality-Aware Visual Reasoning](https://arxiv.org/abs/2507.00008)
*Hang Wu,Hongkai Chen,Yujun Cai,Chang Liu,Qingwen Ye,Ming-Hsuan Yang,Yiwei Wang*

Main category: cs.AI

TL;DR: DiMo-GUI是一个无需训练的框架，通过动态视觉定位和模态感知优化，将GUI分为文本和图标元素，利用分层细化过程提高定位准确性。


<details>
  <summary>Details</summary>
Motivation: 解决GUI中视觉元素多样性和语言模糊性带来的定位挑战。

Method: 将GUI分为文本和图标元素，利用视觉语言模型独立处理每种模态，并通过动态聚焦和分层细化优化结果。

Result: 在标准基准测试中表现优于基线方法，验证了模态分离和区域聚焦的有效性。

Conclusion: DiMo-GUI通过模态分离和动态聚焦策略，无需额外训练即可显著提升GUI定位性能。
...
### [21] [TalentMine: LLM-Based Extraction and Question-Answering from Multimodal Talent Tables](https://arxiv.org/abs/2507.00041)
*Varun Mannam,Fang Wang,Chaochun Liu,Xin Chen*

Main category: cs.AI

TL;DR: TalentMine是一个基于LLM的框架，通过多模态推理增强表格语义表示，显著提升人才管理文档的查询准确性。


<details>
  <summary>Details</summary>
Motivation: 传统表格提取方法在语义理解上表现不佳，导致检索增强聊天应用中的查询失败。

Method: 引入TalentMine框架，将提取的表格转换为语义丰富的表示，保留结构和语义信息。

Result: 在员工福利文档上，TalentMine实现了100%的查询准确率，远超现有方法。

Conclusion: TalentMine通过语义增强的表格表示，解决了当前表格提取中的语义信息丢失问题，为人才管理提供了高效解决方案。
...
### [22] [A collaborative digital twin built on FAIR data and compute infrastructure](https://arxiv.org/abs/2507.00048)
*Thomas M. Deucher,Juan C. Verduzco,Michael Titus,Alejandro Strachan*

Main category: cs.AI

TL;DR: 论文介绍了一种基于nanoHUB服务的分布式自驱动实验室（SDL）实现，通过FAIR数据基础设施和机器学习加速科学和工程中的发现与优化任务。


<details>
  <summary>Details</summary>
Motivation: 通过整合机器学习和自动化实验，促进自驱动实验室之间的协作，加速科学和工程中的优化任务。

Method: 利用nanoHUB服务进行在线模拟和FAIR数据管理，研究人员通过共享数据库贡献数据，并使用自动更新的分析工具和机器学习模型进行优化。

Result: 实现了分布式SDL框架，支持研究人员共享数据、使用机器学习模型进行优化，并通过“节俭双胞胎”概念验证了其在食品染料优化中的应用。

Conclusion: 该框架具有通用性，可扩展到其他优化问题，为科学和工程中的协作与优化提供了新工具。
...
### [23] [SEZ-HARN: Self-Explainable Zero-shot Human Activity Recognition Network](https://arxiv.org/abs/2507.00050)
*Devin Y. De Silva,Sandareka Wickramanayake,Dulani Meedeniya,Sanka Rasnayaka*

Main category: cs.AI

TL;DR: 论文提出了一种新型的自解释零样本人类活动识别网络（SEZ-HARN），能够识别未在训练中遇到的活动并提供骨架视频解释其决策过程。


<details>
  <summary>Details</summary>
Motivation: 现有IMU传感器的人类活动识别（HAR）模型缺乏透明性，且数据覆盖范围有限，限制了其在现实场景中的应用。

Method: 提出SEZ-HARN模型，结合零样本学习和自解释能力，通过骨架视频解释决策过程。

Result: SEZ-HARN在四个基准数据集上表现优异，零样本预测准确率接近最佳黑盒模型，同时提供可理解的解释。

Conclusion: SEZ-HARN在保持高准确率的同时，显著提升了模型的透明性和解释性，适用于实际应用。
...
### [24] [Enhancing Reasoning Capabilities in SLMs with Reward Guided Dataset Distillation](https://arxiv.org/abs/2507.00054)
*Shreyansh Padarha*

Main category: cs.AI

TL;DR: AdvDistill是一种基于奖励的数据集蒸馏框架，通过多代教师模型响应和规则验证器分配奖励，显著提升了学生模型在数学和复杂推理任务中的性能。


<details>
  <summary>Details</summary>
Motivation: 传统知识蒸馏方法中，学生模型仅模仿教师模型的分布内响应，限制了其泛化能力，尤其在推理任务中表现不佳且计算成本高。

Method: 提出AdvDistill框架，利用教师模型对每个提示生成多个响应，并通过规则验证器分配奖励，将这些奖励作为训练学生模型的权重。

Result: 实验表明，AdvDistill显著提升了学生模型在数学和复杂推理任务中的性能。

Conclusion: 在数据集蒸馏过程中引入奖励机制是有效的，能够显著提升学生模型的性能。
...
### [25] [VoyagerVision: Investigating the Role of Multi-modal Information for Open-ended Learning Systems](https://arxiv.org/abs/2507.00079)
*Ethan Smyth,Alessandro Suglia*

Main category: cs.AI

TL;DR: VoyagerVision通过视觉反馈扩展Voyager能力，在Minecraft中成功创建更多结构，展示了多模态模型的潜力。


<details>
  <summary>Details</summary>
Motivation: 通过为模型提供视觉输入，增强其空间环境理解能力，从而扩展其开放环境中的任务执行能力。

Method: 提出了VoyagerVision，一个基于Voyager的多模态模型，利用截图作为视觉反馈，在Minecraft中创建结构。

Result: VoyagerVision在50次迭代中平均创建了2.75个独特结构，且在平坦世界的构建单元测试中成功率为50%。

Conclusion: VoyagerVision通过视觉反馈扩展了Voyager的能力，成功在Minecraft中创建了更多独特结构，展示了多模态模型在开放环境中的潜力。
...
### [26] [Thinking About Thinking: SAGE-nano's Inverse Reasoning for Self-Aware Language Models](https://arxiv.org/abs/2507.00092)
*Basab Jha,Firoj Paudel,Ujjwal Puri,Zhang Yuting,Choi Donghyuk,Wang Junhao*

Main category: cs.AI

TL;DR: 论文提出了一种名为“逆向推理”的新范式，通过SAGE-nano模型实现LLM的自我解释，显著提升了推理透明度和性能。


<details>
  <summary>Details</summary>
Motivation: LLM的推理过程通常被视为黑箱，缺乏透明性。逆向推理旨在解决这一问题，通过分解和解释推理链，提升模型的可解释性和安全性。

Method: 采用逆向推理范式，结合元认知结构和注意力机制，使模型能够回溯决策点并生成解释。SAGE-nano是一个40亿参数的推理模型。

Result: 在AQUA-RAT等测试中，SAGE-nano在推理准确性（74.6%）和解释质量（92.1%人类偏好评分）上表现优异，接近Claude-3.5 Sonnet或GPT-4o。

Conclusion: 逆向推理为透明AI系统开辟了新途径，填补了AI安全性、教育和科学发现中的关键空白。
...
### [27] [BlackBoxToBlueprint: Extracting Interpretable Logic from Legacy Systems using Reinforcement Learning and Counterfactual Analysis](https://arxiv.org/abs/2507.00180)
*Vidhi Rathore*

Main category: cs.AI

TL;DR: 论文提出了一种通过强化学习和决策树自动提取遗留系统决策逻辑的方法，并在虚拟系统上验证了其有效性。


<details>
  <summary>Details</summary>
Motivation: 传统方法仅复制输入输出行为，无法捕捉底层意图，因此需要一种自动提取可解释决策逻辑的方法。

Method: 使用强化学习代理探索输入空间，识别关键决策边界，并通过K-Means聚类和决策树训练提取可读规则。

Result: 在三种不同复杂度的虚拟遗留系统上验证了方法的有效性，提取的规则准确反映了底层逻辑。

Conclusion: 该论文提出的方法通过强化学习代理和决策树提取可解释的决策逻辑，为遗留系统的现代化提供了有效工具。
...
### [28] [ChatGPT produces more "lazy" thinkers: Evidence of cognitive engagement decline](https://arxiv.org/abs/2507.00181)
*Georgios P. Georgiou*

Main category: cs.AI

TL;DR: 研究发现，使用ChatGPT辅助写作的学生认知参与度显著低于对照组，表明AI可能导致认知卸载。
...
Method: 实验设计，随机分配学生至AI辅助（ChatGPT）或非辅助（对照组）条件，完成写作任务后使用CES-AI量表评估认知参与。

Result: ChatGPT组的认知参与度显著低于对照组。

Conclusion: AI辅助可能降低学生的认知参与，需结合教学策略以促进主动学习。
...
### [29] [Table Understanding and (Multimodal) LLMs: A Cross-Domain Case Study on Scientific vs. Non-Scientific Data](https://arxiv.org/abs/2507.00152)
...
### [30] [Prompting as Scientific Inquiry](https://arxiv.org/abs/2507.00163)
...
### [31] [LineRetriever: Planning-Aware Observation Reduction for Web Agents](https://arxiv.org/abs/2507.00210)
...
### [32] [Two-Stage Reasoning-Infused Learning: Improving Classification with LLM-Generated Reasoning](https://arxiv.org/abs/2507.00214)
...
### [33] [Towards Style Alignment in Cross-Cultural Translation](https://arxiv.org/abs/2507.00216)
...
### [34] [Linearly Decoding Refused Knowledge in Aligned Language Models](https://arxiv.org/abs/2507.00239)
...
### [35] [The Algebraic Structure of Morphosyntax](https://arxiv.org/abs/2507.00244)
...
### [36] [EfficientXLang: Towards Improving Token Efficiency Through Cross-Lingual Reasoning](https://arxiv.org/abs/2507.00246)
...
### [37] [Impact of Fine-Tuning Methods on Memorization in Large Language Models](https://arxiv.org/abs/2507.00258)
...
### [38] [Natural language processing for African languages](https://arxiv.org/abs/2507.00297)
...
### [39] [Failure by Interference: Language Models Make Balanced Parentheses Errors When Faulty Mechanisms Overshadow Sound Ones](https://arxiv.org/abs/2507.00322)
...
### [40] [Modeling Data Diversity for Joint Instance and Verbalizer Selection in Cold-Start Scenarios](https://arxiv.org/abs/2507.00330)
...
### [41] [Question Decomposition for Retrieval-Augmented Generation](https://arxiv.org/abs/2507.00355)
...
### [42] [Gregorian melody, modality, and memory: Segmenting chant with Bayesian nonparametrics](https://arxiv.org/abs/2507.00380)
...
### [43] [Causal Prompting for Implicit Sentiment Analysis with Large Language Models](https://arxiv.org/abs/2507.00389)
...
### [44] [Beyond Sociodemographic Prompting: Using Supervision to Align LLMs with Human Response Distributions](https://arxiv.org/abs/2507.00439)
...
### [45] [Pitfalls of Evaluating Language Models with Open Benchmarks](https://arxiv.org/abs/2507.00460)
...
### [46] [TeamCMU at Touché: Adversarial Co-Evolution for Advertisement Integration and Detection in Conversational Search](https://arxiv.org/abs/2507.00509)
...
### [47] [NIRANTAR: Continual Learning with New Languages and Domains on Real-world Speech Data](https://arxiv.org/abs/2507.00534)
...
### [48] [Capsule Network-Based Semantic Intent Modeling for Human-Computer Interaction](https://arxiv.org/abs/2507.00540)
...
### [49] [Methodological Rigour in Algorithm Application: An Illustration of Topic Modelling Algorithm](https://arxiv.org/abs/2507.00547)
*Malmi Amadoru*
...
### [50] [TUM-MiKaNi at SemEval-2025 Task 3: Towards Multilingual and Knowledge-Aware Non-factual Hallucination Identification](https://arxiv.org/abs/2507.00579)
...
### [51] [Transferable Modeling Strategies for Low-Resource LLM Tasks: A Prompt and Alignment-Based](https://arxiv.org/abs/2507.00601)
...
### [52] [Mixture of Reasonings: Teach Large Language Models to Reason with Adaptive Strategies](https://arxiv.org/abs/2507.00606)
...
### [53] [SAFER: Probing Safety in Reward Models with Sparse Autoencoder](https://arxiv.org/abs/2507.00665)
...
### [54] [Contrasting Cognitive Styles in Vision-Language Models: Holistic Attention in Japanese Versus Analytical Focus in English](https://arxiv.org/abs/2507.00700)
...
### [55] [AI Analyst: Framework and Comprehensive Evaluation of Large Language Models for Financial Time Series Report Generation](https://arxiv.org/abs/2507.00718)
...
### [56] [LitBench: A Benchmark and Dataset for Reliable Evaluation of Creative Writing](https://arxiv.org/abs/2507.00769)
...
### [57] [A Diagrammatic Calculus for a Functional Model of Natural Language Semantics](https://arxiv.org/abs/2507.00782)
...
### [58] [Generative AI and the future of scientometrics: current topics and future questions](https://arxiv.org/abs/2507.00783)
...
### [59] [Many LLMs Are More Utilitarian Than One](https://arxiv.org/abs/2507.00814)
...
### [60] [ProxAnn: Use-Oriented Evaluations of Topic Models and Document Clustering](https://arxiv.org/abs/2507.00828)
...
### [61] [Stylometry recognizes human and LLM-generated texts in short samples](https://arxiv.org/abs/2507.00838)
...
### [62] [TransLaw: Benchmarking Large Language Models in Multi-Agent Simulation of the Collaborative Translation](https://arxiv.org/abs/2507.00875)
...
### [63] [Mathematics Isn't Culture-Free: Probing Cultural Gaps via Entity and Scenario Perturbations](https://arxiv.org/abs/2507.00883)
...
### [64] [Scaling Laws Are Unreliable for Downstream Tasks: A Reality Check](https://arxiv.org/abs/2507.00885)
...
### [65] [MemeCMD: An Automatically Generated Chinese Multi-turn Dialogue Dataset with Contextually Retrieved Memes](https://arxiv.org/abs/2507.00891)
...
### [66] [The Cognate Data Bottleneck in Language Phylogenetics](https://arxiv.org/abs/2507.00911)
...
### [67] [Discourse Heuristics For Paradoxically Moral Self-Correction](https://arxiv.org/abs/2507.00985)
...
### [68] [Should We Still Pretrain Encoders with Masked Language Modeling?](https://arxiv.org/abs/2507.00994)
...
### [69] [La Leaderboard: A Large Language Model Leaderboard for Spanish Varieties and Languages of Spain and Latin America](https://arxiv.org/abs/2507.00999)
...
### [70] [SciArena: An Open Evaluation Platform for Foundation Models in Scientific Literature Tasks](https://arxiv.org/abs/2507.01001)
...
### [71] [Table Understanding and (Multimodal) LLMs: A Cross-Domain Case Study on Scientific vs. Non-Scientific Data](https://arxiv.org/abs/2507.00152)
*Ekaterina Borisova,Fabio Barth,Nils Feldhus,Raia Abu Ahmad,Malte Ostendorff,Pedro Ortiz Suarez,Georg Rehm,Sebastian Möller*

Main category: cs.CL

TL;DR: 本文研究了文本和多模态LLM在表格理解任务中的表现，发现LLM在处理科学表格时面临挑战。
...
Method: 通过跨领域和跨模态评估，比较LLM在科学与非科学表格中的表现，并分析其在不同格式（图像、文本等）下的鲁棒性。

Result: LLM在表格模态间表现稳健，但在处理科学表格时存在显著困难。

Conclusion: 研究强调了LLM在处理复杂表格数据时的局限性，并提出了TableEval基准以促进未来研究。
...
### [72] [Prompting as Scientific Inquiry](https://arxiv.org/abs/2507.00163)
*Ari Holtzman,Chenhao Tan*

Main category: cs.CL

TL;DR: Prompting is a legitimate scientific method for LLMs, akin to behavioral science, not just alchemy.


<details>
  <summary>Details</summary>
Motivation: To challenge the perception of prompting as alchemy and establish it as a legitimate scientific approach in LLM research.

Method: Treating prompting as behavioral science, analogous to studying a complex organism, and comparing it to mechanistic interpretability.

Result: Prompting is argued to be a key component in the science of LLMs, equivalent to behavioral science for complex organisms.

Conclusion: Prompting is a fundamental and legitimate scientific method for studying and controlling large language models, not just a workaround.
...
### [73] [LineRetriever: Planning-Aware Observation Reduction for Web Agents](https://arxiv.org/abs/2507.00210)
*Imene Kerboua,Sahar Omidi Shayegan,Megh Thakkar,Xing Han Lù,Massimo Caccia,Véronique Eglin,Alexandre Aussem,Jérémy Espinas,Alexandre Lacoste*

Main category: cs.CL

TL;DR: LineRetriever 是一种新方法，通过语言模型优化检索，减少观察内容大小并保持性能，适用于网页导航任务。


<details>
  <summary>Details</summary>
Motivation: 当前的方法（如自底向上截断或基于嵌入的检索）在网页导航任务中丢失了关键信息，尤其是对于自适应规划的网页代理，理解当前状态对未来行动至关重要。

Method: 提出了一种名为 LineRetriever 的新方法，利用语言模型识别并检索与未来导航步骤最相关的观察行。

Result: 实验表明，LineRetriever 能够在上下文限制内保持一致的性能，同时减少每一步的观察内容大小。

Conclusion: LineRetriever 是一种有效的方法，能够在保持性能的同时减少观察内容的大小，适用于自适应规划的网页导航任务。
...
### [74] [Two-Stage Reasoning-Infused Learning: Improving Classification with LLM-Generated Reasoning](https://arxiv.org/abs/2507.00214)
*Mads Henrichsen,Rasmus Krebs*

Main category: cs.CL

TL;DR: 论文提出了一种两阶段方法，利用LLM生成的推理增强文本分类性能，显著提高了情感分类的准确性。
...
Result: 在情感分类任务中，生成推理和情感的分类器比仅生成情感的分类器准确率提高了8.7个百分点。

Conclusion: LLM生成的推理可以丰富训练数据，提升下游NLP任务性能并提供显式解释。
...
### [75] [Towards Style Alignment in Cross-Cultural Translation](https://arxiv.org/abs/2507.00216)
*Shreya Havaldar,Adam Stein,Eric Wong,Lyle Ungar*

Main category: cs.CL

TL;DR: RASTA方法通过检索增强的风格对齐，改善了LLM在翻译风格时的表现，尤其是在非西方语言中。


<details>
  <summary>Details</summary>
Motivation: 文化差异常导致说话者意图与听者理解之间的风格不对齐，例如礼貌在翻译中常丢失。LLM在翻译风格时偏向中性，且在非西方语言中表现较差。

Method: RASTA（检索增强的风格对齐）方法，通过学习风格概念来鼓励LLM翻译适当传达文化沟通规范。

Result: RASTA方法能够改善LLM在翻译风格时的表现，尤其是在非西方语言中，使其更符合文化沟通规范。

Conclusion: RASTA方法通过利用学习到的风格概念，有效缓解了LLM在翻译风格时的失败，尤其是在非西方语言中，从而更好地传达文化沟通规范。
...
### [76] [Linearly Decoding Refused Knowledge in Aligned Language Models](https://arxiv.org/abs/2507.00239)
*Aryan Shrivastava,Ari Holtzman*

Main category: cs.CL

TL;DR: 研究发现，即使经过指令调优的语言模型，其隐藏状态中仍可通过线性探针解码出被拒绝的有害信息，表明这些信息并未被完全消除或重新定位。


<details>
  <summary>Details</summary>
Motivation: 探讨指令调优的语言模型是否真正消除了有害信息，还是仅仅抑制了其直接表达。

Method: 使用线性探针训练在语言模型的隐藏状态上，解码被拒绝的信息，并分析其可访问性和对下游行为的影响。

Result: 线性探针能够高精度预测被拒绝的信息（如国家平均智商），且这些信息在指令调优模型中仍被使用。

Conclusion: 指令调优并未完全消除有害信息，而是抑制其直接表达，这些信息仍可通过线性探针访问并影响下游行为。
...
### [77] [The Algebraic Structure of Morphosyntax](https://arxiv.org/abs/2507.00244)
*Isabella Senturia,Matilde Marcolli*

Main category: cs.CL

TL;DR: 论文通过数学建模重新定义了形态学与句法学的接口，提出了一种基于操作代数和形态学共积的新理论框架。


<details>
  <summary>Details</summary>
Motivation: 在强简约主义理论的背景下，探索形态学与句法学接口的数学表达，以解决形态学中缺乏移动的问题。

Method: 采用数学方法，特别是操作代数和形态学共积的概念，对形态学与句法学的接口进行建模。

Result: 提出了一个基于操作代数的形态句法树形成模型，并通过形态学共积扩展了形态学树的集合。

Conclusion: 该论文通过数学建模重新解释了形态学与句法学的接口，提出了一种基于操作代数和形态学共积的对应关系，为形态句法树的形成提供了新的理论框架。
...
### [78] [EfficientXLang: Towards Improving Token Efficiency Through Cross-Lingual Reasoning](https://arxiv.org/abs/2507.00246)
*Sanchit Ahuja,Praneetha Vaddamanu,Barun Patra*
...
Method: 评估三个开源语言推理模型（DeepSeek R1、Qwen 2.5和Qwen 3）在四个数学数据集和七种语言中的表现。

Result: 非英语语言在推理任务中减少token使用并保持准确性，且效果优于英语。

Conclusion: 研究强调了多语言推理的潜力及强大多语言基础的重要性。
...
### [79] [Impact of Fine-Tuning Methods on Memorization in Large Language Models](https://arxiv.org/abs/2507.00258)
*Jie Hou,Chuxiong Wu,Lannan Luo,Qiang Zeng*

Main category: cs.CL

TL;DR: 研究表明，基于提示的微调在保持性能的同时，比基于参数的微调更隐私安全。


<details>
  <summary>Details</summary>
Motivation: 探讨不同微调方法对隐私风险的影响，尤其是记忆化问题。

Method: 分类流行微调方法，并通过成员推理攻击（MIAs）评估其记忆化影响。

Result: 基于提示的微调在性能竞争的同时，对MIAs的脆弱性更低，且不受模型规模影响。
...
### [80] [Natural language processing for African languages](https://arxiv.org/abs/2507.00297)
*David Ifeoluwa Adelani*

Main category: cs.CL

TL;DR: 该论文探讨了低资源语言（特别是撒哈拉以南非洲语言）在NLP中的挑战，通过构建高质量语料库和标注数据集，研究了词嵌入和多语言预训练语言模型的性能与适应性。


<details>
  <summary>Details</summary>
Motivation: 解决低资源语言在NLP研究中代表性不足的问题，尤其是撒哈拉以南非洲语言，这些语言缺乏高质量的标注数据和网络数据。

Method: 分析公开语料库的噪声，构建高质量语料库；研究词嵌入和多语言预训练语言模型的性能；开发大规模标注数据集；进行监督、弱监督和迁移学习的实证评估。

Result: 证明了数据质量对词嵌入语义表示的重要性；展示了多语言预训练语言模型在低资源语言中的潜力；为21种非洲语言构建了标注数据集。

Conclusion: 通过高质量数据和多语言预训练语言模型的结合，可以有效提升低资源语言的NLP性能，填补了非洲语言在NLP研究中的空白。
...
### [81] [Moment Sampling in Video LLMs for Long-Form Video QA](https://arxiv.org/abs/2507.00033)
...
### [82] [Catastrophic Forgetting Mitigation via Discrepancy-Weighted Experience Replay](https://arxiv.org/abs/2507.00042)
...
### [83] [MR-CLIP: Efficient Metadata-Guided Learning of MRI Contrast Representations](https://arxiv.org/abs/2507.00043)
...
### [84] [Evolutionary computing-based image segmentation method to detect defects and features in Additive Friction Stir Deposition Process](https://arxiv.org/abs/2507.00046)
...
### [85] [HistoART: Histopathology Artifact Detection and Reporting Tool](https://arxiv.org/abs/2507.00044)
...
### [86] [CaughtCheating: Is Your MLLM a Good Cheating Detective? Exploring the Boundary of Visual Perception and Reasoning](https://arxiv.org/abs/2507.00045)
...
### [87] [AdaDeDup: Adaptive Hybrid Data Pruning for Efficient Large-Scale Object Detection Training](https://arxiv.org/abs/2507.00049)
...
### [88] [VSF-Med:A Vulnerability Scoring Framework for Medical Vision-Language Models](https://arxiv.org/abs/2507.00052)
...
### [89] [MANTA: Cross-Modal Semantic Alignment and Information-Theoretic Optimization for Long-form Multimodal Understanding](https://arxiv.org/abs/2507.00068)
...
### [90] [An efficient plant disease detection using transfer learning approach](https://arxiv.org/abs/2507.00070)
...
### [91] [Diffusion-Based Image Augmentation for Semantic Segmentation in Outdoor Robotics](https://arxiv.org/abs/2507.00153)
...
### [92] [FreeLong++: Training-Free Long Video Generation via Multi-band SpectralFusion](https://arxiv.org/abs/2507.00162)
*Yu Lu,Yi Yang*
...
### [93] [SelvaBox: A high-resolution dataset for tropical tree crown detection](https://arxiv.org/abs/2507.00170)
...
### [94] [Graph-Based Deep Learning for Component Segmentation of Maize Plants](https://arxiv.org/abs/2507.00182)
...
### [95] [Computer Vision for Objects used in Group Work: Challenges and Opportunities](https://arxiv.org/abs/2507.00224)
...
### [96] [VOCAL: Visual Odometry via ContrAstive Learning](https://arxiv.org/abs/2507.00243)
...
### [97] [Developing Lightweight DNN Models With Limited Data For Real-Time Sign Language Recognition](https://arxiv.org/abs/2507.00248)
...
### [98] [GazeTarget360: Towards Gaze Target Estimation in 360-Degree for Robot Perception](https://arxiv.org/abs/2507.00253)
...
### [99] [VirtualFencer: Generating Fencing Bouts based on Strategies Extracted from In-the-Wild Videos](https://arxiv.org/abs/2507.00261)
...
### [100] [Room Scene Discovery and Grouping in Unstructured Vacation Rental Image Collections](https://arxiv.org/abs/2507.00263)
...
### [101] [Self-Supervised Multiview Xray Matching](https://arxiv.org/abs/2507.00287)
...
### [102] [Reducing Variability of Multiple Instance Learning Methods for Digital Pathology](https://arxiv.org/abs/2507.00292)
...
### [103] [Beyond Low-Rank Tuning: Model Prior-Guided Rank Allocation for Effective Transfer in Low-Data and Large-Gap Regimes](https://arxiv.org/abs/2507.00327)
...
### [104] [MammoTracker: Mask-Guided Lesion Tracking in Temporal Mammograms](https://arxiv.org/abs/2507.00328)
...
### [105] [Populate-A-Scene: Affordance-Aware Human Video Generation](https://arxiv.org/abs/2507.00334)
...
### [106] [Training for X-Ray Vision: Amodal Segmentation, Amodal Content Completion, and View-Invariant Object Representation from Multi-Camera Video](https://arxiv.org/abs/2507.00339)
...
### [107] [CGEarthEye:A High-Resolution Remote Sensing Vision Foundation Model Based on the Jilin-1 Satellite Constellation](https://arxiv.org/abs/2507.00356)
...
### [108] [GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control](https://arxiv.org/abs/2507.00363)
...
### [109] [An Improved U-Net Model for Offline handwriting signature denoising](https://arxiv.org/abs/2507.00365)
*Wanghui Xiao*
...
### [110] [Out-of-Distribution Detection with Adaptive Top-K Logits Integration](https://arxiv.org/abs/2507.00368)
...
### [111] [PlantSegNeRF: A few-shot, cross-dataset method for plant 3D instance point cloud reconstruction via joint-channel NeRF with multi-view image instance matching](https://arxiv.org/abs/2507.00371)
...
### [112] [Efficient Depth- and Spatially-Varying Image Simulation for Defocus Deblur](https://arxiv.org/abs/2507.00372)
...
### [113] [Customizable ROI-Based Deep Image Compression](https://arxiv.org/abs/2507.00373)
...
### [114] [MedDiff-FT: Data-Efficient Diffusion Model Fine-tuning with Structural Guidance for Controllable Medical Image Synthesis](https://arxiv.org/abs/2507.00377)
...
### [115] [Learning Dense Feature Matching via Lifting Single 2D Image to 3D Space](https://arxiv.org/abs/2507.00392)
...
### [116] [Few-shot Classification as Multi-instance Verification: Effective Backbone-agnostic Transfer across Domains](https://arxiv.org/abs/2507.00401)
...
### [117] [DiGA3D: Coarse-to-Fine Diffusional Propagation of Geometry and Appearance for Versatile 3D Inpainting](https://arxiv.org/abs/2507.00429)
...
### [118] [MFH: Marrying Frequency Domain with Handwritten Mathematical Expression Recognition](https://arxiv.org/abs/2507.00430)
...
### [119] [Latent Posterior-Mean Rectified Flow for Higher-Fidelity Perceptual Face Restoration](https://arxiv.org/abs/2507.00447)
...
### [120] [ATSTrack: Enhancing Visual-Language Tracking by Aligning Temporal and Spatial Scales](https://arxiv.org/abs/2507.00454)
...
### [121] [Unleashing the Potential of All Test Samples: Mean-Shift Guided Test-Time Adaptation](https://arxiv.org/abs/2507.00462)
...
### [122] [Bisecle: Binding and Separation in Continual Learning for Video Language Understanding](https://arxiv.org/abs/2507.00469)
...
### [123] [ARIG: Autoregressive Interactive Head Generation for Real-time Conversations](https://arxiv.org/abs/2507.00472)
...
### [124] [ADAptation: Reconstruction-based Unsupervised Active Learning for Breast Ultrasound Diagnosis](https://arxiv.org/abs/2507.00474)
...
### [125] [Just Noticeable Difference for Large Multimodal Models](https://arxiv.org/abs/2507.00490)
...
### [126] [Visual Anagrams Reveal Hidden Differences in Holistic Shape Processing Across Vision Models](https://arxiv.org/abs/2507.00493)
...
### [127] [Laplace-Mamba: Laplace Frequency Prior-Guided Mamba-CNN Fusion Network for Image Dehazing](https://arxiv.org/abs/2507.00501)
...
### [128] [ExPaMoE: An Expandable Parallel Mixture of Experts for Continual Test-Time Adaptation](https://arxiv.org/abs/2507.00502)
...
### [129] [LLaVA-SP: Enhancing Visual Representation with Visual Spatial Tokens for MLLMs](https://arxiv.org/abs/2507.00505)
...
### [130] [SCING:Towards More Efficient and Robust Person Re-Identification through Selective Cross-modal Prompt Tuning](https://arxiv.org/abs/2507.00506)
...
### [131] [Topology-Constrained Learning for Efficient Laparoscopic Liver Landmark Detection](https://arxiv.org/abs/2507.00519)
...
### [132] [Box-QAymo: Box-Referring VQA Dataset for Autonomous Driving](https://arxiv.org/abs/2507.00525)
...
### [133] [Not All Attention Heads Are What You Need: Refining CLIP's Image Representation with Attention Ablation](https://arxiv.org/abs/2507.00537)
...
### [134] [LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing](https://arxiv.org/abs/2507.00554)
...
### [135] [Zero-shot Skeleton-based Action Recognition with Prototype-guided Feature Alignment](https://arxiv.org/abs/2507.00566)
...
### [136] [Out-of-distribution detection in 3D applications: a review](https://arxiv.org/abs/2507.00570)
...
### [137] [AI-Generated Video Detection via Perceptual Straightening](https://arxiv.org/abs/2507.00583)
...
### [138] [Similarity Memory Prior is All You Need for Medical Image Segmentation](https://arxiv.org/abs/2507.00585)
...
### [139] [Context-Aware Academic Emotion Dataset and Benchmark](https://arxiv.org/abs/2507.00586)
...
### [140] [Overtake Detection in Trucks Using CAN Bus Signals: A Comparative Study of Machine Learning Methods](https://arxiv.org/abs/2507.00593)
...
### [141] [World4Drive: End-to-End Autonomous Driving via Intention-aware Physical Latent World Model](https://arxiv.org/abs/2507.00603)
...
### [142] [ONLY: One-Layer Intervention Sufficiently Mitigates Hallucinations in Large Vision-Language Models](https://arxiv.org/abs/2507.00898)
...
### [143] [De-Simplifying Pseudo Labels to Enhancing Domain Adaptive Object Detection](https://arxiv.org/abs/2507.00608)
...
### [144] [UMDATrack: Unified Multi-Domain Adaptive Tracking Under Adverse Weather Conditions](https://arxiv.org/abs/2507.00648)
...
### [145] [LoD-Loc v2: Aerial Visual Localization over Low Level-of-Detail City Models using Explicit Silhouette Alignment](https://arxiv.org/abs/2507.00659)
...
### [146] [A Unified Transformer-Based Framework with Pretraining For Whole Body Grasping Motion Generation](https://arxiv.org/abs/2507.00676)
...
### [147] [Cage-Based Deformation for Transferable and Undefendable Point Cloud Attack](https://arxiv.org/abs/2507.00690)
...
### [148] [Rectifying Magnitude Neglect in Linear Attention](https://arxiv.org/abs/2507.00698)
...
### [149] [BEV-VAE: Multi-view Image Generation with Spatial Consistency for Autonomous Driving](https://arxiv.org/abs/2507.00707)
...
### [150] [TopoStreamer: Temporal Lane Segment Topology Reasoning in Autonomous Driving](https://arxiv.org/abs/2507.00709)
...
### [151] [UPRE: Zero-Shot Domain Adaptation for Object Detection via Unified Prompt and Representation Enhancement](https://arxiv.org/abs/2507.00721)
...
### [152] [Holmes: Towards Effective and Harmless Model Ownership Verification to Personalized Large Vision Models via Decoupling Common Features](https://arxiv.org/abs/2507.00724)
...
### [153] [Biorthogonal Tunable Wavelet Unit with Lifting Scheme in Convolutional Neural Network](https://arxiv.org/abs/2507.00739)
...
### [154] [Improving the Reasoning of Multi-Image Grounding in MLLMs via Reinforcement Learning](https://arxiv.org/abs/2507.00748)
...
### [155] [Multi-Modal Graph Convolutional Network with Sinusoidal Encoding for Robust Human Action Segmentation](https://arxiv.org/abs/2507.00752)
...
### [156] [Language-Unlocked ViT (LUViT): Empowering Self-Supervised Vision Transformers with LLMs](https://arxiv.org/abs/2507.00754)
...
### [157] [Towards Open-World Human Action Segmentation Using Graph Convolutional Networks](https://arxiv.org/abs/2507.00756)
...
### [158] [OptiPrune: Boosting Prompt-Image Consistency with Attention-Guided Noise and Dynamic Token Selection](https://arxiv.org/abs/2507.00789)
*Ziji Lu*
...
### [159] [LD-RPS: Zero-Shot Unified Image Restoration via Latent Diffusion Recurrent Posterior Sampling](https://arxiv.org/abs/2507.00790)
...
### [160] [Real-Time Inverse Kinematics for Generating Multi-Constrained Movements of Virtual Human Characters](https://arxiv.org/abs/2507.00792)
...
### [161] [TRACE: Temporally Reliable Anatomically-Conditioned 3D CT Generation with Enhanced Efficiency](https://arxiv.org/abs/2507.00802)
...
### [162] [CAVALRY-V: A Large-Scale Generator Framework for Adversarial Attacks on Video MLLMs](https://arxiv.org/abs/2507.00817)
...
### [163] [Instant Particle Size Distribution Measurement Using CNNs Trained on Synthetic Data](https://arxiv.org/abs/2507.00822)
...
### [164] [High-Frequency Semantics and Geometric Priors for End-to-End Detection Transformers in Challenging UAV Imagery](https://arxiv.org/abs/2507.00825)
...
### [165] [Do Echo Top Heights Improve Deep Learning Nowcasts?](https://arxiv.org/abs/2507.00845)
...
### [166] [UAVD-Mamba: Deformable Token Fusion Vision Mamba for Multimodal UAV Detection](https://arxiv.org/abs/2507.00849)
...
### [167] [Robust Component Detection for Flexible Manufacturing: A Deep Learning Approach to Tray-Free Object Recognition under Variable Lighting](https://arxiv.org/abs/2507.00852)
...
### [168] [SafeMap: Robust HD Map Construction from Incomplete Observations](https://arxiv.org/abs/2507.00861)
...
### [169] [Is Visual in-Context Learning for Compositional Medical Tasks within Reach?](https://arxiv.org/abs/2507.00868)
...
### [170] [GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond](https://arxiv.org/abs/2507.00886)
...
### [171] [Masks make discriminative models great again!](https://arxiv.org/abs/2507.00916)
...
### [172] [MVP: Winning Solution to SMP Challenge 2025 Video Track](https://arxiv.org/abs/2507.00950)
...
### [173] [Surgical Neural Radiance Fields from One Image](https://arxiv.org/abs/2507.00969)
...
### [174] [RTMap: Real-Time Recursive Mapping with Change Detection and Localization](https://arxiv.org/abs/2507.00980)
...
### [175] [Evaluating Robustness of Monocular Depth Estimation with Procedural Scene Perturbations](https://arxiv.org/abs/2507.00981)
...
### [176] [UniGlyph: Unified Segmentation-Conditioned Diffusion for Precise Visual Text Synthesis](https://arxiv.org/abs/2507.00992)
...
### [177] [GLM-4.1V-Thinking: Towards Versatile Multimodal Reasoning with Scalable Reinforcement Learning](https://arxiv.org/abs/2507.01006)
...
### [178] [ShapeEmbed: a self-supervised learning framework for 2D contour quantification](https://arxiv.org/abs/2507.01009)
...
### [179] [DAM-VSR: Disentanglement of Appearance and Motion for Video Super-Resolution](https://arxiv.org/abs/2507.01012)
...
### [180] [Moment Sampling in Video LLMs for Long-Form Video QA](https://arxiv.org/abs/2507.00033)
*Mustafa Chasmai,Gauri Jagatap,Gouthaman KV,Grant Van Horn,Subhransu Maji,Andrea Fanelli*

Main category: cs.CV

TL;DR: 提出“时刻采样”方法，通过问题上下文优化帧选择，提升长视频问答性能。


<details>
  <summary>Details</summary>
Motivation: 现有方法在长视频中表现不佳，帧子采样常导致关键帧丢失或冗余信息增加，影响问答准确性。

Method: 提出了一种模型无关的“时刻采样”方法，利用轻量级时刻检索模型优先选择与问题最相关的帧。

Result: 在四个长视频问答数据集和四种最先进的视频大语言模型上验证了方法的有效性。

Conclusion: 提出的“时刻采样”方法通过问题上下文指导帧选择，显著提升了视频大语言模型在长视频问答中的性能。
...
### [181] [Catastrophic Forgetting Mitigation via Discrepancy-Weighted Experience Replay](https://arxiv.org/abs/2507.00042)
*Xinrun Xu,Jianwen Yang,Qiuhong Zhang,Zhanbiao Lian,Zhiming Ding,Shan Jiang*

Main category: cs.CV

TL;DR: ER-EMU算法通过自适应经验回放和领域距离度量选择历史数据，提升云边协同目标检测模型在动态交通环境中的知识保留和适应能力。


<details>
  <summary>Details</summary>
Motivation: 动态交通环境中的周期性变化导致模型在适应新数据分布时出现灾难性遗忘问题，现有方法无法有效利用历史数据。

Method: 提出ER-EMU算法，结合FIFO经验缓冲区和DDM-ES算法，利用MK-MMD度量领域差异，优先选择与当前目标领域差异大的历史数据。

Result: 在Bellevue交通视频数据集上，ER-EMU显著提升了多个云边协同目标检测框架的性能。

Conclusion: ER-EMU通过优化历史数据选择和缓冲策略，有效解决了灾难性遗忘问题，提升了模型在动态环境中的适应能力。
...
### [182] [MR-CLIP: Efficient Metadata-Guided Learning of MRI Contrast Representations](https://arxiv.org/abs/2507.00043)
*Mehmet Yigit Avci,Pedro Borges,Paul Wright,Mehmet Yigitsoy,Sebastien Ourselin,Jorge Cardoso*

Main category: cs.CV

TL;DR: MR-CLIP 是一种无需人工标注的多模态对比学习框架，通过学习 MRI 图像与 DICOM 元数据的对应关系，生成对比感知的表示，解决了元数据不完整和标签缺失的问题。


<details>
  <summary>Details</summary>
Motivation: MRI 扫描的准确解释依赖于对图像对比度的精确理解，但现有标签（如 T1 加权或 T2 加权）过于粗略，且许多数据集中缺乏这些标签。此外，元数据常不完整、嘈杂或不一致，导致图像解释、检索和临床工作流集成困难。

Method: 提出 MR-CLIP，一种多模态对比学习框架，通过对齐 MRI 图像与其 DICOM 元数据来学习对比感知的表示。

Result: MR-CLIP 能够捕捉不同扫描仪和协议下的对比度变化，生成解剖学不变的表示，并在跨模态检索和对比分类中表现优异。

Conclusion: MR-CLIP 是一种多模态对比学习框架，能够通过学习 DICOM 元数据与 MRI 图像的对应关系，生成对比感知的表示，无需依赖人工标注。该方法在跨模态检索和对比分类中表现出色，具有扩展性和潜在的临床应用价值。
...
### [183] [Evolutionary computing-based image segmentation method to detect defects and features in Additive Friction Stir Deposition Process](https://arxiv.org/abs/2507.00046)
*Akshansh Mishra,Eyob Mesele Sefene,Shivraman Thapliyal*

Main category: cs.CV

TL;DR: 该论文提出了一种基于进化计算的图像分割方法，用于分析增材摩擦搅拌沉积（AFSD）过程中的完整性。通过粒子群优化（PSO）确定最佳分割阈值，结合梯度分析和距离变换，生成新颖的注意力加权可视化，揭示了传统成像难以观察到的缺陷区域。


<details>
  <summary>Details</summary>
Motivation: 传统成像方法难以检测AFSD过程中的细微缺陷和材料过渡区域，因此需要一种更精确的自动分割和可视化技术。

Method: 使用PSO算法优化分割阈值，结合梯度幅度分析和距离变换，生成注意力加权和多通道可视化技术。

Result: PSO自动确定了最佳阈值（156-173），多通道可视化技术成功量化了界面质量，揭示了不完全结合和不均匀区域。

Conclusion: 注意力加权分析为AFSD工艺优化和质量评估提供了定量指标，证明了其在检测缺陷和材料过渡方面的有效性。
...
### [184] [HistoART: Histopathology Artifact Detection and Reporting Tool](https://arxiv.org/abs/2507.00044)
*Seyed Kahaki,Alexander R. Webber,Ghada Zamzmi,Adarsh Subbaswamy,Rucha Deshpande,Aldo Badano*
...
Method: The paper proposes and compares three artifact detection approaches for WSIs: (1) a foundation model-based approach (FMA) using a fine-tuned Unified Neural Image (UNI) architecture, (2) a deep learning approach (DLA) built on a ResNet50 backbone, and (3) a knowledge-based approach (KBA) leveraging handcrafted features. Evaluations were conducted on 50,000+ image patches from diverse scanners.

Result: The FMA achieved the highest patch-wise AUROC of 0.995, outperforming the DLA (AUROC: 0.977) and the KBA (AUROC: 0.940). A quality report scorecard was developed to quantify high-quality patches and visualize artifact distributions.

Conclusion: The study concludes that the foundation model-based approach (FMA) outperforms both the deep learning approach (DLA) and the knowledge-based approach (KBA) in detecting artifacts in Whole Slide Imaging (WSI), achieving the highest patch-wise AUROC of 0.995. The quality report scorecard provides actionable insights for improving diagnostic accuracy.
...
### [185] [CaughtCheating: Is Your MLLM a Good Cheating Detective? Exploring the Boundary of Visual Perception and Reasoning](https://arxiv.org/abs/2507.00045)
*Ming Li,Chenguang Wang,Yijun Liang,Xiyao Wang,Yuhang Zhou,Xiyang Wu,Yuqing Zhang,Ruiyi Zhang,Tianyi Zhou*

Main category: cs.CV

TL;DR: 论文提出了CaughtCheating任务，发现现有MLLMs在此类挑战性任务中表现不佳，为提升MLLMs的感知和推理能力提供了方向。


<details>
  <summary>Details</summary>
Motivation: 由于现有MLLMs在现有基准测试中表现接近天花板，需要更具挑战性的任务来评估其能力，尤其是模拟人类侦探的感知和推理能力。

Method: 通过实验和分析，研究了GPT-o3在CaughtCheating任务中的表现，并探讨了现有MLLMs能力不足的原因。

Result: 发现GPT-o3在CaughtCheating任务中表现几乎为零，揭示了现有MLLMs在此类任务中的能力不足。

Conclusion: CaughtCheating任务为多模态大语言模型（MLLMs）提供了一个具有挑战性的视觉感知和推理任务，成功解决此类任务将推动MLLMs达到人类侦探水平的感知和推理能力。
...
### [186] [AdaDeDup: Adaptive Hybrid Data Pruning for Efficient Large-Scale Object Detection Training](https://arxiv.org/abs/2507.00049)
*Feiyang Kang,Nadine Chang,Maying Shen,Marc T. Law,Rafid Mahmood,Ruoxi Jia,Jose M. Alvarez*

Main category: cs.CV

TL;DR: AdaDeDup是一种新型混合框架，结合密度修剪和模型反馈，自适应调整修剪阈值，显著提升数据效率。
...
Method: AdaDeDup通过密度修剪和模型反馈的协同作用，自适应调整聚类特定修剪阈值。

Result: 在多个大规模目标检测基准上，AdaDeDup显著优于基线方法，减少性能下降，并在修剪20%数据时接近原始模型性能。
...
### [187] [VSF-Med:A Vulnerability Scoring Framework for Medical Vision-Language Models](https://arxiv.org/abs/2507.00052)
*Binesh Sadanandan,Vahid Behzadan*

Main category: cs.CV

TL;DR: VSF--Med是一个端到端的医疗视觉语言模型（VLM）漏洞评分框架，通过文本提示攻击模板、视觉扰动和八维评分标准，评估医疗VLM的安全性。


<details>
  <summary>Details</summary>
Motivation: 医疗VLM在临床环境中的安全性评估不足，亟需系统化的漏洞检测方法。

Method: VSF--Med结合了文本攻击模板、视觉扰动和LLM评分标准，生成30,000个对抗样本，并通过z-score归一化计算综合风险指标。

Result: 实验显示，Llama-3.2-11B-Vision-Instruct在攻击持续性上表现最脆弱（1.29σ），而GPT-4o在提示注入攻击上表现较好（0.28σ）。
...
### [188] [MANTA: Cross-Modal Semantic Alignment and Information-Theoretic Optimization for Long-form Multimodal Understanding](https://arxiv.org/abs/2507.00068)
*Ziqi Zhong,Daniel Tang*

Main category: cs.CV

TL;DR: MANTA 是一个统一视觉和听觉输入到结构化文本空间的多模态学习框架，显著提升了长视频问答等任务的性能。


<details>
  <summary>Details</summary>
Motivation: 当前多模态学习方法将模态分开处理，导致表示和推理不一致，MANTA 旨在解决这一问题。

Method: MANTA 通过信息理论优化实现跨模态语义对齐，自适应时间同步，分层内容表示和上下文感知检索，结合严格的数学框架。

Result: 在长视频问答任务中，MANTA 将最先进模型的准确率提高了 22.6%，在超过 30 分钟的视频中提升 27.3%，并在时间推理和跨模态理解任务中分别提升 23.8% 和 25.1%。

Conclusion: MANTA 通过结构化文本统一多模态表示，为多模态学习提供了新的理论基础，并在长视频问答等任务中显著提升了性能。
...
### [189] [An efficient plant disease detection using transfer learning approach](https://arxiv.org/abs/2507.00070)
*Bosubabu Sambana,Hillary Sunday Nnadi,Mohd Anas Wajid,Nwosu Ogochukwu Fidelia,Claudia Camacho-Zuñiga,Henry Dozie Ajuzie,Edeh Michael Onyema*

Main category: cs.CV

TL;DR: 该研究提出了一种基于YOLOv7和YOLOv8的迁移学习系统，用于自动检测植物病害，结果显示YOLOv8在性能上优于其他方法。


<details>
  <summary>Details</summary>
Motivation: 植物病害对农业造成严重影响，早期检测至关重要，而技术进步为自动化监测提供了机会。

Method: 使用YOLOv7和YOLOv8模型，通过微调植物叶片图像数据集来检测细菌、真菌和病毒病害。

Result: 模型在mAP、F1-score、Precision和Recall等指标上表现优异，YOLOv8尤其突出。
...
### [190] [Ensemble Kalman Filter for Data Assimilation coupled with low-resolution computations techniques applied in Fluid Dynamics](https://arxiv.org/abs/2507.00539)
...
### [191] [Ensemble Kalman Filter for Data Assimilation coupled with low-resolution computations techniques applied in Fluid Dynamics](https://arxiv.org/abs/2507.00539)
*Paul Jeanney,Ashton Hetherington,Shady E. Ahmed,David Lanceta,Susana Saiz,José Miguel Perez,Soledad Le CLainche*

Main category: cs.CE

TL;DR: 论文提出了一种基于降阶模型和数据同化的新方法，显著降低了计算成本并保持了预测精度，适用于流体动力学的大规模应用。


<details>
  <summary>Details</summary>
Motivation: 为了解决数据同化（DA）在流体动力学中计算成本高的问题，论文提出了一种高效的降阶模型（ROM），以平衡计算效率和预测精度。

Method: 论文采用了一种新颖的降维框架下的集成卡尔曼滤波（EnKF）方法，结合低分辨率（LR）技术和低成本奇异值分解（lcSVD）进行数据重建。

Result: 实验结果表明，该方法在压缩率为15.9时，计算速度提升了13.7倍，内存使用减少了90.9%，同时保持了较低的相对均方根误差（RRMSE）为2.6%。

Conclusion: 该论文提出的降阶模型（ROM）通过数据同化（DA）技术，成功实现了实验与模拟数据的融合，显著提高了流体动力学系统的预测准确性。该方法在计算效率和内存使用上均有显著优化，适用于大规模和实时应用。
...
### [192] [Hypertokens: Holographic Associative Memory in Tokenized LLMs](https://arxiv.org/abs/2507.00002)
...
### [193] [Data Collection with Non-Uniform Axial Power for Phase II of the OECD/NEA AI/ML Critical Heat Flux Benchmark](https://arxiv.org/abs/2507.00034)
...
### [194] [Deciding When Not to Decide: Indeterminacy-Aware Intrusion Detection with NeutroSENSE](https://arxiv.org/abs/2507.00003)
*Eyhab Al-Masri*
...
### [195] [A Theory of Inference Compute Scaling: Reasoning through Directed Stochastic Skill Search](https://arxiv.org/abs/2507.00004)
...
### [196] [Novel RL approach for efficient Elevator Group Control Systems](https://arxiv.org/abs/2507.00011)
...
### [197] [Towards Undistillable Models by Minimizing Conditional Mutual Information](https://arxiv.org/abs/2507.00012)
...
### [198] [ST-MTM: Masked Time Series Modeling with Seasonal-Trend Decomposition for Time Series Forecasting](https://arxiv.org/abs/2507.00013)
...
### [199] [Variational Autoencoder for Generating Broader-Spectrum prior Proposals in Markov chain Monte Carlo Methods](https://arxiv.org/abs/2507.00020)
...
### [200] [SWE-Bench-CL: Continual Learning for Coding Agents](https://arxiv.org/abs/2507.00014)
...
### [201] [Generalizing to New Dynamical Systems via Frequency Domain Adaptation](https://arxiv.org/abs/2507.00025)
...
### [202] [Vision Transformer with Adversarial Indicator Token against Adversarial Attacks in Radio Signal Classifications](https://arxiv.org/abs/2507.00015)
...
### [203] [Fractional Policy Gradients: Reinforcement Learning with Long-Term Memory](https://arxiv.org/abs/2507.00073)
...
### [204] [Gradient-based Fine-Tuning through Pre-trained Model Regularization](https://arxiv.org/abs/2507.00016)
...
### [205] [What Makes Local Updates Effective: The Role of Data Heterogeneity and Smoothness](https://arxiv.org/abs/2507.00195)
*Kumar Kshitij Patel*
...
### [206] [Implicit Reward as the Bridge: A Unified View of SFT and DPO Connections](https://arxiv.org/abs/2507.00018)
...
### [207] [Best Agent Identification for General Game Playing](https://arxiv.org/abs/2507.00451)
...
### [208] [Quantum Inspired Encoding Strategies for Machine Learning Models: Proposing and Evaluating Instance Level, Global Discrete, and Class Conditional Representations](https://arxiv.org/abs/2507.00019)
...
### [209] [Posterior Inference in Latent Space for Scalable Constrained Black-box Optimization](https://arxiv.org/abs/2507.00480)
...
### [211] [GLU Attention Improve Transformer](https://arxiv.org/abs/2507.00022)
*Zehao Wang*
...
### [212] [Ordinality in Discrete-level Question Difficulty Estimation: Introducing Balanced DRPS and OrderedLogitNN](https://arxiv.org/abs/2507.00736)
...
### [213] [AIMatDesign: Knowledge-Augmented Reinforcement Learning for Inverse Materials Design under Data Scarcity](https://arxiv.org/abs/2507.00024)
...
### [214] [ROSE: Toward Reality-Oriented Safety Evaluation of Large Language Models](https://arxiv.org/abs/2507.00026)
...
### [215] [HiT-JEPA: A Hierarchical Self-supervised Trajectory Embedding Framework for Similarity Computation](https://arxiv.org/abs/2507.00028)
...
### [216] [Structure-preserving Lift & Learn: Scientific machine learning for nonlinear conservative partial differential equations](https://arxiv.org/abs/2507.00301)
...
### [217] [LoRA-Mixer: Coordinate Modular LoRA Experts Through Serial Attention Routing](https://arxiv.org/abs/2507.00029)
...
### [218] [Adaptive Action Duration with Contextual Bandits for Deep Reinforcement Learning in Dynamic Environments](https://arxiv.org/abs/2507.00030)
...
### [219] [Enhancing Spatio-Temporal Forecasting with Spatial Neighbourhood Fusion:A Case Study on COVID-19 Mobility in Peru](https://arxiv.org/abs/2507.00031)
...
### [220] [IDRIFTNET: Physics-Driven Spatiotemporal Deep Learning for Iceberg Drift Forecasting](https://arxiv.org/abs/2507.00036)
...
### [221] [Model Fusion via Neuron Interpolation](https://arxiv.org/abs/2507.00037)
...
### [222] [Quality over Quantity: An Effective Large-Scale Data Reduction Strategy Based on Pointwise V-Information](https://arxiv.org/abs/2507.00038)
...
### [223] [Pattern-Based Graph Classification: Comparison of Quality Measures and Importance of Preprocessing](https://arxiv.org/abs/2507.00039)
...
### [224] [Leveraging Unlabeled Audio-Visual Data in Speech Emotion Recognition using Knowledge Distillation](https://arxiv.org/abs/2507.00055)
...
### [225] [Smooth-Distill: A Self-distillation Framework for Multitask Learning with Wearable Sensor Data](https://arxiv.org/abs/2507.00061)
...
### [226] [Theoretical Modeling of LLM Self-Improvement Training Dynamics Through Solver-Verifier Gap](https://arxiv.org/abs/2507.00075)
...
### [227] [The language of time: a language model perspective on time-series foundation models](https://arxiv.org/abs/2507.00078)
...
### [228] [Online Meal Detection Based on CGM Data Dynamics](https://arxiv.org/abs/2507.00080)
...
### [229] [Federated Learning-Enabled Hybrid Language Models for Communication-Efficient Token Transmission](https://arxiv.org/abs/2507.00082)
...
### [230] [Strategic Counterfactual Modeling of Deep-Target Airstrike Systems via Intervention-Aware Spatio-Causal Graph Networks](https://arxiv.org/abs/2507.00083)
*Wei Meng*
...
### [231] [A Joint Topology-Data Fusion Graph Network for Robust Traffic Speed Prediction with Data Anomalism](https://arxiv.org/abs/2507.00085)
...
### [232] [pUniFind: a unified large pre-trained deep learning model pushing the limit of mass spectra interpretation](https://arxiv.org/abs/2507.00087)
...
### [233] [A new machine learning framework for occupational accidents forecasting with safety inspections integration](https://arxiv.org/abs/2507.00089)
...
### [234] [Generating Heterogeneous Multi-dimensional Data : A Comparative Study](https://arxiv.org/abs/2507.00090)
...
### [235] [DFReg: A Physics-Inspired Framework for Global Weight Distribution Regularization in Neural Networks](https://arxiv.org/abs/2507.00101)
*Giovanni Ruggieri*
...
### [236] [Towards transparent and data-driven fault detection in manufacturing: A case study on univariate, discrete time series](https://arxiv.org/abs/2507.00102)
...
### [237] [Graph Neural Networks in Wind Power Forecasting](https://arxiv.org/abs/2507.00105)
...
### [238] [Text-to-Level Diffusion Models With Various Text Encoders for Super Mario Bros](https://arxiv.org/abs/2507.00184)
...
### [239] [Beyond Sensor Data: Foundation Models of Behavioral Data from Wearables Improve Health Predictions](https://arxiv.org/abs/2507.00191)
...
### [240] [PPFL-RDSN: Privacy-Preserving Federated Learning-based Residual Dense Spatial Networks for Encrypted Lossy Image Reconstruction](https://arxiv.org/abs/2507.00230)
...
### [241] [Interpretable AI for Time-Series: Multi-Model Heatmap Fusion with Global Attention and NLP-Generated Explanations](https://arxiv.org/abs/2507.00234)
...
### [242] [Gym4ReaL: A Suite for Benchmarking Real-World Reinforcement Learning](https://arxiv.org/abs/2507.00257)
...
### [243] [Who Should I Listen To? Adaptive Collaboration in Personalized Federated Learning](https://arxiv.org/abs/2507.00259)
...
### [244] [Examining Reject Relations in Stimulus Equivalence Simulations](https://arxiv.org/abs/2507.00265)
...
### [245] [Double Q-learning for Value-based Deep Reinforcement Learning, Revisited](https://arxiv.org/abs/2507.00275)
...
### [246] [MamNet: A Novel Hybrid Model for Time-Series Forecasting and Frequency Pattern Analysis in Network Traffic](https://arxiv.org/abs/2507.00304)
...
### [247] [Open-ended Scientific Discovery via Bayesian Surprise](https://arxiv.org/abs/2507.00310)
...
### [248] [$μ^2$Tokenizer: Differentiable Multi-Scale Multi-Modal Tokenizer for Radiology Report Generation](https://arxiv.org/abs/2507.00316)
...
### [249] [Exploring Theory-Laden Observations in the Brain Basis of Emotional Experience](https://arxiv.org/abs/2507.00320)
...
### [250] [Data-Driven Exploration for a Class of Continuous-Time Linear--Quadratic Reinforcement Learning Problems](https://arxiv.org/abs/2507.00358)
...
### [251] [MoNE: Replacing Redundant Experts with Lightweight Novices for Structured Pruning of MoE](https://arxiv.org/abs/2507.00390)
...
### [252] [HelixPipe: Efficient Distributed Training of Long Sequence Transformers with Attention Parallel Pipeline Parallelism](https://arxiv.org/abs/2507.00394)
...
### [253] [Diffusion Disambiguation Models for Partial Label Learning](https://arxiv.org/abs/2507.00411)
...
### [254] [Flexible Language Modeling in Continuous Space with Transformer-based Autoregressive Flows](https://arxiv.org/abs/2507.00425)
...
### [255] [A Recipe for Causal Graph Regression: Confounding Effects Revisited](https://arxiv.org/abs/2507.00440)
...
### [256] [Overcoming Long-Context Limitations of State-Space Models via Context-Dependent Sparse Attention](https://arxiv.org/abs/2507.00449)
...
### [257] [Iterative Distillation for Reward-Guided Fine-Tuning of Diffusion Models in Biomolecular Design](https://arxiv.org/abs/2507.00445)
...
### [258] [Recurrent Memory-Augmented Transformers with Chunked Attention for Long-Context Language Modeling](https://arxiv.org/abs/2507.00453)
*Ankit Kashyap*
...
### [259] [Diversity Conscious Refined Random Forest](https://arxiv.org/abs/2507.00467)
...
### [261] [Exploring Large Action Sets with Hyperspherical Embeddings using von Mises-Fisher Sampling](https://arxiv.org/abs/2507.00518)
...
### [262] [Foundation Models for Clinical Records at Health System Scale](https://arxiv.org/abs/2507.00574)
...
### [263] [Quantum Circuit Structure Optimization for Quantum Reinforcement Learning](https://arxiv.org/abs/2507.00589)
...
### [264] [Residual Reward Models for Preference-based Reinforcement Learning](https://arxiv.org/abs/2507.00611)
...
### [265] [Cooperative Sheaf Neural Networks](https://arxiv.org/abs/2507.00647)
...
### [266] [Cognitive Load-Aware Inference: A Neuro-Symbolic Framework for Optimizing the Token Economy of Large Language Models](https://arxiv.org/abs/2507.00653)
*Yilun Zhang*
...
### [267] [Neural Augmented Kalman Filters for Road Network assisted GNSS positioning](https://arxiv.org/abs/2507.00654)
...
### [268] [Audio-3DVG: Unified Audio - Point Cloud Fusion for 3D Visual Grounding](https://arxiv.org/abs/2507.00669)
...
### [269] [Diffusion Classifier Guidance for Non-robust Classifiers](https://arxiv.org/abs/2507.00687)
...
### [270] [A Test-Function Approach to Incremental Stability](https://arxiv.org/abs/2507.00695)
...
### [271] [SCAWaveNet: A Spatial-Channel Attention-based Network for Global Significant Wave Height Retrieval](https://arxiv.org/abs/2507.00701)
...
### [272] [Large Reasoning Models are not thinking straight: on the unreliability of thinking trajectories](https://arxiv.org/abs/2507.00711)
...
### [273] [Aleatoric and Epistemic Uncertainty Measures for Ordinal Classification through Binary Reduction](https://arxiv.org/abs/2507.00733)
...
### [274] [Evaluating LLMs and Prompting Strategies for Automated Hardware Diagnosis from Textual User-Reports](https://arxiv.org/abs/2507.00742)
...
### [275] [A Probabilistic Approach to Wildfire Spread Prediction Using a Denoising Diffusion Surrogate Model](https://arxiv.org/abs/2507.00761)
...
### [276] [Leveraging Genetic Algorithms for Efficient Demonstration Generation in Real-World Reinforcement Learning Environments](https://arxiv.org/abs/2507.00762)
...
### [277] [BoltzNCE: Learning Likelihoods for Boltzmann Generation with Stochastic Interpolants and Noise Contrastive Estimation](https://arxiv.org/abs/2507.00846)
...
### [278] [Quantum Approximate Optimization Algorithm for Spatiotemporal Forecasting of HIV Clusters](https://arxiv.org/abs/2507.00848)
...
### [279] [Aligning Learning and Endogenous Decision-Making](https://arxiv.org/abs/2507.00851)
...
### [280] [Machine Learning-based Early Detection of Potato Sprouting Using Electrophysiological Signals](https://arxiv.org/abs/2507.00862)
...
### [281] [NN-Former: Rethinking Graph Structure in Neural Architecture Representation](https://arxiv.org/abs/2507.00880)
...
### [282] [TABASCO: A Fast, Simplified Model for Molecular Generation with Improved Physical Quality](https://arxiv.org/abs/2507.00899)
...
### [283] [Privacy-Preserving Quantized Federated Learning with Diverse Precision](https://arxiv.org/abs/2507.00920)
...
### [284] [Understanding Generalization in Node and Link Prediction](https://arxiv.org/abs/2507.00927)
...
### [285] [Time Series Foundation Models are Flow Predictors](https://arxiv.org/abs/2507.00945)
...
### [286] [Benchmarking the Discovery Engine](https://arxiv.org/abs/2507.00964)
...
### [287] [Scalable Feature Learning on Huge Knowledge Graphs for Downstream Machine Learning](https://arxiv.org/abs/2507.00965)
...
### [288] [Reasoning as an Adaptive Defense for Safety](https://arxiv.org/abs/2507.00971)
...
### [289] [Description of the Training Process of Neural Networks via Ergodic Theorem : Ghost nodes](https://arxiv.org/abs/2507.01003)
...
### [290] [ZeCO: Zero Communication Overhead Sequence Parallelism for Linear Attention](https://arxiv.org/abs/2507.01004)
...
### [291] [Hypertokens: Holographic Associative Memory in Tokenized LLMs](https://arxiv.org/abs/2507.00002)
*Christopher James Augeri*

Main category: cs.LG

TL;DR: HDRAM框架通过结合经典纠错码、全息计算和量子启发搜索，解决了LLM中的信息扩散问题，提升了关联检索效率。


<details>
  <summary>Details</summary>
Motivation: LLMs存在信息扩散问题，导致精度损失，需要一种新的方法来处理其键值记忆问题。

Method: 提出HDRAM框架，利用超令牌和相位相干内存地址，结合ECC、全息计算和量子启发搜索，实现高效的信息恢复和检索。

Result: HDRAM显著提升了关联检索效率，且无需改变模型架构。

Conclusion: HDRAM展示了经典-全息-量子启发原则如何增强Transformer架构，为解决LLM的信息扩散问题提供了新思路。
...
### [292] [Data Collection with Non-Uniform Axial Power for Phase II of the OECD/NEA AI/ML Critical Heat Flux Benchmark](https://arxiv.org/abs/2507.00034)
*Reece Bourisaw,Reid McCants,Jean-Marie Le Corre,Anna Iskhakova,Arsen S. Iskhakov*

Main category: cs.LG

TL;DR: 本文为OECD/NEA AI/ML CHF基准测试的第二阶段提供了涵盖均匀和非均匀轴向加热条件的CHF数据集，并展示了传统方法和神经网络在预测CHF时的局限性。


<details>
  <summary>Details</summary>
Motivation: 支持OECD/NEA AI/ML CHF基准测试的第二阶段，该阶段引入了空间变化的功率分布，需要更全面的数据集和模型来预测CHF。

Method: 通过从技术报告中提取加热曲线，插值到一致的轴向网格上，并通过能量平衡检查验证，最终编码为机器可读格式。

Result: 传统CHF相关性在均匀加热下误差较大，在非均匀加热下表现更差；神经网络在均匀数据上表现良好，但无法推广到非均匀场景。

Conclusion: 研究为后续的迁移学习策略、不确定性量化和设计优化提供了基础，强调了需要显式纳入轴向功率分布的模型。
...
### [293] [Deciding When Not to Decide: Indeterminacy-Aware Intrusion Detection with NeutroSENSE](https://arxiv.org/abs/2507.00003)
*Eyhab Al-Masri*

Main category: cs.LG

TL;DR: NeutroSENSE是一个基于中性逻辑的集成框架，用于IoT环境中的可解释入侵检测，通过分解预测置信度为真、假和不确定成分，实现了高准确率和不确定性量化。


<details>
  <summary>Details</summary>
Motivation: IoT环境中的入侵检测需要高准确性和可解释性，同时需要处理不确定性以支持可信的AI决策。

Method: 结合随机森林、XGBoost和逻辑回归，利用中性逻辑将预测置信度分解为真（T）、假（F）和不确定（I）成分，并使用全局和自适应阈值标记高不确定性预测。

Result: 在IoT-CAD数据集上达到97%的准确率，并证明误分类样本的不确定性显著高于正确分类样本。

Conclusion: 中性逻辑不仅提高了准确性和可解释性，还为边缘部署中的可信AI决策提供了实用基础。
...
### [294] [A Theory of Inference Compute Scaling: Reasoning through Directed Stochastic Skill Search](https://arxiv.org/abs/2507.00004)
*Austin R. Ellis-Mohr,Anuj K. Nayak,Lav R. Varshney*

Main category: cs.LG

TL;DR: 论文提出了一种名为DS3的框架，用于优化大语言模型的推理成本，通过技能图随机遍历实现高效推理策略。


<details>
  <summary>Details</summary>
Motivation: 大语言模型的推理成本日益成为资源负担，现有方法未能全面考虑计算最优性。

Method: 引入DS3框架，将推理建模为技能图的随机遍历，并推导出任务成功率和计算成本的闭式表达式。

Result: 理论分析揭示了线性精度与对数计算的关系，以及不同推理策略的适用性。

Conclusion: DS3框架深化了对训练-推理相互依赖的理解，支持算法设计和资源分配。
...
### [295] [Novel RL approach for efficient Elevator Group Control Systems](https://arxiv.org/abs/2507.00011)
*Nathan Vaartjes,Vincent Francois-Lavet*

Main category: cs.LG

TL;DR: 论文提出了一种基于强化学习的电梯群控系统，通过新颖的动作空间编码和基础设施步骤优化调度，优于传统方法。


<details>
  <summary>Details</summary>
Motivation: 大型建筑中高效的电梯交通管理对于最小化乘客出行时间和能源消耗至关重要。由于基于启发式或模式检测的控制器在处理电梯调度的随机性和组合复杂性方面存在困难，因此需要一种更有效的解决方案。

Method: 论文将电梯调度问题建模为马尔可夫决策过程（MDP），并训练了一个端到端的强化学习（RL）电梯群控系统（EGCS）。关键创新包括新颖的动作空间编码、引入基础设施步骤以模拟连续乘客到达，以及定制的奖励信号以提高学习效率。

Result: 研究表明，基于强化学习的EGCS能够适应波动的交通模式，并从高度随机的环境中学习，从而优于传统的基于规则的算法。

Conclusion: 论文提出的基于强化学习的电梯群控系统（EGCS）能够适应波动的交通模式，并从高度随机的环境中学习，从而优于传统的基于规则的算法。
...
### [296] [Towards Undistillable Models by Minimizing Conditional Mutual Information](https://arxiv.org/abs/2507.00012)
*Linfeng Ye,Shayan Mohajer Hamidi,En-hui Yang*

Main category: cs.LG

TL;DR: A new CMIM method trains DNNs to be undistillable by minimizing CMI values, protecting intellectual property while maintaining accuracy.


<details>
  <summary>Details</summary>
Motivation: To protect intellectual property of DNNs by making them undistillable through knowledge distillation.

Method: The CMIM method jointly minimizes cross entropy loss and CMI values of temperature-scaled clusters across the entire temperature spectrum.

Result: The CMIM model is undistillable by all tested KD methods and outperforms models trained with CE loss alone in prediction accuracy.

Conclusion: The CMIM method successfully creates undistillable DNNs by minimizing CMI values, ensuring knockoff students underperform LS students while maintaining high prediction accuracy.
...
### [297] [ST-MTM: Masked Time Series Modeling with Seasonal-Trend Decomposition for Time Series Forecasting](https://arxiv.org/abs/2507.00013)
*Hyunwoo Seo,Chiehyeon Lim*

Main category: cs.LG

TL;DR: ST-MTM是一种结合季节性-趋势分解的掩码时间序列建模框架，通过改进掩码策略和对比学习任务，显著提升了复杂时间序列的预测性能。
...
Method: 提出ST-MTM框架，采用季节性-趋势分解方法，分别对季节性和趋势成分设计不同的掩码策略，并结合对比学习任务。

Result: 实验表明，ST-MTM在预测性能上优于现有掩码建模、对比学习和监督预测方法。

Conclusion: ST-MTM通过分解和针对性掩码策略，有效捕捉了时间序列的复杂时序依赖关系，提升了预测准确性。
...
### [298] [Variational Autoencoder for Generating Broader-Spectrum prior Proposals in Markov chain Monte Carlo Methods](https://arxiv.org/abs/2507.00020)
*Marcio Borges,Felipe Pereira,Michel Tosin*

Main category: cs.LG

TL;DR: 使用变分自编码器（VAE）改进马尔可夫链蒙特卡洛（McMC）方法，生成更广泛的先验提案，提高计算效率和适应性。


<details>
  <summary>Details</summary>
Motivation: 传统方法（如KLE）需要已知协方差函数，这在实践中往往不可得。VAE提供了一种数据驱动的方法，能更灵活地捕捉相关性结构。

Method: 采用VAE框架，在贝叶斯反问题（如地下水流建模）中生成先验提案，并通过合成地下水流动反演问题进行测试。

Result: VAE在已知相关长度时与KLE精度相当，在相关长度假设偏离真实值时优于KLE，且显著降低随机维度，提高计算效率。

Conclusion: 在McMC方法中利用深度生成模型（如VAE）可以提高高维贝叶斯推断的适应性和效率。
...
### [299] [SWE-Bench-CL: Continual Learning for Coding Agents](https://arxiv.org/abs/2507.00014)
*Thomas Joshi,Shayan Chowdhury,Fatih Uysal*

Main category: cs.LG

TL;DR: SWE-Bench-CL是一个新的持续学习基准测试，用于评估AI代理在软件工程中的适应性和稳健性。


<details>
  <summary>Details</summary>
Motivation: 评估AI代理在持续学习环境中的能力，包括积累经验、跨任务知识转移和抵抗灾难性遗忘。

Method: 通过组织GitHub问题为按时间顺序排列的序列，并引入LangGraph-based评估框架和FAISS支持的语义记忆模块，以及专门的持续学习指标。

Result: 提出了SWE-Bench-CL基准测试，并提供了代码和数据集，支持社区开发更适应和稳健的AI代理。

Conclusion: SWE-Bench-CL 提供了一个可重复的平台，用于开发更适应和稳健的AI代理，以应对软件工程中的持续学习挑战。
...
### [300] [Generalizing to New Dynamical Systems via Frequency Domain Adaptation](https://arxiv.org/abs/2507.00025)
*Tiexin Qin,Hong Yan,Haoliang Li*

Main category: cs.LG

TL;DR: FNSDA是一种参数高效的方法，通过在傅里叶空间中适应新动态，能够泛化到未见过的系统。


<details>
  <summary>Details</summary>
Motivation: 当前方法在特定领域内可靠预测能力有限，且难以泛化到具有相同动态但环境特征不同的系统。

Method: FNSDA通过傅里叶模式自动分区识别可共享动态，并通过低维潜在系统参数调整特定模式。

Result: 在四个代表性动态系统家族上，FNSDA在泛化性能上优于或与现有方法竞争，且参数成本显著降低。

Conclusion: FNSDA展示了在复杂动态系统中高效泛化的潜力，为未来研究提供了新方向。
...
### [301] [Vision Transformer with Adversarial Indicator Token against Adversarial Attacks in Radio Signal Classifications](https://arxiv.org/abs/2507.00015)
*Lu Zhang,Sangarapillai Lambotharan,Gan Zheng,Guisheng Liao,Xuekang Liu,Fabio Roli,Carsten Maple*

Main category: cs.LG

TL;DR: 提出一种带对抗指示器令牌的ViT架构，结合训练和运行时防御，有效抵御对抗攻击，实验表现优异。


<details>
  <summary>Details</summary>
Motivation: Transformer在自动调制分类中的应用受到对抗攻击的威胁，因此需要一种有效的防御策略来保护基于Transformer的分类系统。

Method: 提出了一种新的视觉Transformer（ViT）架构，引入了对抗指示器（AdvI）令牌来检测对抗攻击，并结合对抗训练方法和检测机制。通过研究注意力机制，验证了AdvI令牌在ViT中的关键作用。

Result: 实验证明，该方法在白盒攻击场景（如快速梯度法、投影梯度下降攻击和基本迭代方法）中优于多种竞争方法。

Conclusion: 本文提出了一种新颖的视觉Transformer架构，通过引入对抗指示器（AdvI）令牌来检测对抗攻击，并在统一的神经网络模型中结合训练时防御和运行时防御，显著降低了系统复杂性。实验结果表明，该方法在白盒攻击场景下优于多种竞争方法。
...
### [302] [Fractional Policy Gradients: Reinforcement Learning with Long-Term Memory](https://arxiv.org/abs/2507.00073)
*Urvi Pawar,Kunal Telangi*

Main category: cs.LG

TL;DR: FPG利用分数阶微积分改进策略梯度方法，显著提升样本效率和方差减少。
...
Method: 通过Caputo分数阶导数重新定义梯度，建立状态转移间的幂律时间相关性，并开发高效递归计算技术。

Result: 实验显示FPG在样本效率上提升35-68%，方差减少24-52%。

Conclusion: FPG为利用长程依赖提供了数学基础，且无额外计算开销。
...
### [303] [Gradient-based Fine-Tuning through Pre-trained Model Regularization](https://arxiv.org/abs/2507.00016)
*Xuanbo Liu,Liu Liu,Fuxiang Wu,Fusheng Hao,Xianglong Liu*

Main category: cs.LG

TL;DR: GRFT是一种高效的基于梯度和正则化的微调方法，通过更新权重矩阵的行或列来减少存储开销并提高参数选择效率，性能优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 大型预训练模型在微调时需要大量计算资源和存储空间，现有方法如GPS虽然减少了训练参数，但增加了计算和存储需求。

Method: 提出GRFT方法，通过更新权重矩阵中梯度平方和最高的行或列，并结合正则化来增强知识迁移。

Result: GRFT在FGVC和VTAB数据集上仅需更新1.22%和0.30%的参数，性能优于GPS、Adapter Tuning和LoRA。

Conclusion: GRFT是一种高效且有效的微调方法，显著减少了存储和计算需求，同时保持了高性能。
...
### [304] [Localized evaluation and fast summation in the extrapolated regularization method for integrals in Stokes flow](https://arxiv.org/abs/2507.00156)
...
### [305] [An energy-stable parametric finite element method for Willmore flow with normal-tangential velocity splitting](https://arxiv.org/abs/2507.00193)
...
### [306] [Error Etimates for Non Conforming Discretisation of Time-dependent Convection-Diffusion-Reaction Model](https://arxiv.org/abs/2507.00219)
...
### [307] [Minimal residual rational Krylov subspace method for sequences of shifted linear systems](https://arxiv.org/abs/2507.00267)
...
### [308] [Automatic discovery of optimal meta-solvers for time-dependent nonlinear PDEs](https://arxiv.org/abs/2507.00278)
...
### [309] [Adaptive finite element convergence analysis of AT1 phase-field model for quasi-static fracture in strain-limiting solids](https://arxiv.org/abs/2507.00376)
...
### [310] [The Fourier spectral approach to the spatial discretization of quasilinear hyperbolic systems](https://arxiv.org/abs/2507.00516)
...
### [311] [A hyperboloidal method for numerical simulations of multidimensional nonlinear wave equations](https://arxiv.org/abs/2507.00674)
*Oliver Rinne*
...
### [312] [An inverse-free fixed-time stable dynamical system and its forward-Euler discretization for solving generalized absolute value equations](https://arxiv.org/abs/2507.00531)
...
### [313] [Isogeometric contact analysis in subsea umbilical and power cables](https://arxiv.org/abs/2507.00563)
...
### [314] [Special measures of smoothness for approximation by sampling operators in $L_p(\Bbb{R}^d)$](https://arxiv.org/abs/2507.00667)
*Yurii Kolomoitsev*
...
### [315] [High order global flux schemes for general steady state preservation of shallow water moment equations with non-conservative products](https://arxiv.org/abs/2507.00573)
...
### [316] [Accelerating MPGP-type Methods Through Preconditioning](https://arxiv.org/abs/2507.00617)
...
### [317] [Sectional Kolmogorov N-widths for parameter-dependent function spaces: A general framework with application to parametrized Friedrichs' systems](https://arxiv.org/abs/2507.00678)
...
### [318] [Analysis of A Mixed Finite Element Method for Poisson's Equation with Rough Boundary Data](https://arxiv.org/abs/2507.00697)
...
### [319] [Multi-goal-oriented anisotropic error control and mesh adaptivity for time-dependent convection-dominated problems](https://arxiv.org/abs/2507.00723)
...
### [320] [A posteriori and a priori error estimates for linearized thin sheet folding](https://arxiv.org/abs/2507.00807)
...
### [321] [Localized evaluation and fast summation in the extrapolated regularization method for integrals in Stokes flow](https://arxiv.org/abs/2507.00156)
*Joseph Siebor,Svetlana Tlupova*

Main category: math.NA

TL;DR: 本文提出了一种降低计算成本的边界积分方程方法，用于处理斯托克斯流的单层和双层积分，通过并行化、局部求和和树码技术优化了计算效率。


<details>
  <summary>Details</summary>
Motivation: 边界积分方程方法在解决偏微分方程时广泛使用，但核函数在边界附近几乎奇异，导致数值积分不准确。本文旨在降低计算成本，提高效率。

Method: 采用OpenMP并行化、局部求和和树码技术，优化了正则化方法在斯托克斯单层和双层积分中的应用。

Result: 通过实验确定了计算精度和效率的最佳参数，并成功应用于计算两个几乎接触的球体周围的斯托克斯流。

Conclusion: 提出的技术显著降低了计算成本，同时保持了高精度，适用于复杂几何形状的斯托克斯流计算。
...
### [322] [An energy-stable parametric finite element method for Willmore flow with normal-tangential velocity splitting](https://arxiv.org/abs/2507.00193)
*Harald Garcke,Robert Nürnberg,Quan Zhao*

Main category: math.NA

TL;DR: 提出了一种能量稳定的全离散参数化方法，用于计算二维和三维空间中的Willmore流，支持自发曲率效应和开放边界曲面。


<details>
  <summary>Details</summary>
Motivation: 研究Willmore流在几何处理中的应用，特别是在存在自发曲率和开放边界的情况下，需要一种稳定且高效的计算方法。

Method: 通过结合平均曲率演化方程和切向速度方程，提出了一种新的几何偏微分方程（PDE），并基于此设计了全离散参数化有限元方法。

Result: 该方法在离散能量下具有无条件稳定性，并通过数值实验验证了其在二维曲线和三维曲面上的准确性和鲁棒性。

Conclusion: 所提出的方法在计算Willmore流时表现出优异的稳定性和计算效率，适用于复杂几何形状的处理。
...
### [323] [Error Etimates for Non Conforming Discretisation of Time-dependent Convection-Diffusion-Reaction Model](https://arxiv.org/abs/2507.00219)
*Hasan Alzubaidi,Yahya Alnashri*

Main category: math.NA

TL;DR: 论文通过GDM框架为对流-扩散-反应模型提供统一数值分析，验证了收敛速率和解的存在性，并通过HMM方法在GBF模型上测试了准确性。


<details>
  <summary>Details</summary>
Motivation: 为一般时间依赖的对流-扩散-反应模型提供一个统一的数值分析框架，并验证其在不同应用中的有效性。

Method: 采用梯度离散化方法（GDM）进行数值分析，并通过混合模拟混合（HMM）方法对广义Burgers-Fisher（GBF）模型进行数值测试。

Result: 数值测试结果验证了理论收敛速率，即使在极端扭曲的网格上也能保持准确性。

Conclusion: 该论文通过梯度离散化方法（GDM）为一般时间依赖的对流-扩散-反应模型提供了统一的数值分析框架，证明了在合理假设下数值逼近的收敛速率，并验证了近似解的存在性和唯一性。
...
### [324] [Minimal residual rational Krylov subspace method for sequences of shifted linear systems](https://arxiv.org/abs/2507.00267)
*Hussam Al Daas,Davide Palitta*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法在处理非对称问题且移位为复数且不成共轭对时表现不佳，亟需更高效的求解器。

Method: 设计了基于有理Krylov子空间和最小残差条件的投影策略，并开发了一种新的极点选择方法。

Result: 数值实验表明，新方法在复杂非对称问题上优于现有技术。

Conclusion: 该论文提出了一种基于有理Krylov子空间和最小残差条件的新型投影策略，以及针对特定问题的极点选择方法，显著提升了复杂非对称问题的求解效率。
...
### [325] [Automatic discovery of optimal meta-solvers for time-dependent nonlinear PDEs](https://arxiv.org/abs/2507.00278)
*Youngkyu Lee,Shanqing Liu,Jerome Darbon,George Em Karniadakis*

Main category: math.NA

TL;DR: 提出了一种自动化发现最优元求解器的通用框架，结合传统数值方法和深度学习组件，用于求解时间依赖非线性偏微分方程。


<details>
  <summary>Details</summary>
Motivation: 传统数值方法在处理复杂非线性偏微分方程时可能效率不足，需要更灵活、高效的求解器设计。

Method: 结合Krylov方法和神经算子，将求解器发现建模为多目标优化问题，平衡精度、速度和内存使用。

Result: 在反应扩散、流体动力学和固体力学问题中，发现的元求解器优于传统迭代方法。

Conclusion: 该框架具有高效性和广泛适用性，为求解器选择提供了理论基础。
...
### [326] [Adaptive finite element convergence analysis of AT1 phase-field model for quasi-static fracture in strain-limiting solids](https://arxiv.org/abs/2507.00376)
*Ram Manohar,S. M. Mallikarjunaiah*

Main category: math.NA

TL;DR: 该研究提出了两种自适应网格细化算法，用于解决非线性能量最小化问题，并通过收敛分析和数值模拟验证了其有效性。


<details>
  <summary>Details</summary>
Motivation: 研究旨在解决弹性固体中准静态脆性断裂的正则化变分模型的自适应有限元方法收敛性问题，特别是针对具有代数非线性应力-应变关系的材料模型。

Method: 研究引入了两种基于局部误差指标的自适应网格细化算法，并对生成的极小化序列进行了详细的收敛分析。

Result: 第一种算法的极小化序列能够收敛到预设容差，而第二种算法则无需显式停止准则即可生成收敛序列。数值模拟验证了算法的实际有效性。

Conclusion: 该研究通过详细的收敛分析和数值模拟，验证了两种自适应网格细化算法在解决非线性能量最小化问题中的有效性，特别是第二种算法无需显式停止准则即可生成收敛序列。
...
### [327] [The Fourier spectral approach to the spatial discretization of quasilinear hyperbolic systems](https://arxiv.org/abs/2507.00516)
*Vincent Duchêne,Johanna Ulvedal Marstrander*

Main category: math.NA

TL;DR: 傅里叶谱方法用于拟线性双曲系统的空间离散化，证明了谱收敛性，平滑低通滤波器适用范围更广。


<details>
  <summary>Details</summary>
Motivation: 探讨拟线性一阶双曲系统的空间离散化问题，旨在验证傅里叶谱方法的有效性及其适用范围。

Method: 采用傅里叶谱方法进行空间离散化，并提供了均匀稳定性估计。

Result: 证明了半离散解在满足结构假设时能够谱收敛于连续解，并发现平滑低通滤波器在理论上更具普适性。

Conclusion: 本文通过傅里叶谱方法对拟线性一阶双曲系统进行空间离散化的严格论证，证明了在满足适当结构假设的条件下，半离散解能够谱收敛于连续解。同时，指出了平滑低通滤波器在理论上适用于更广泛的系统类别。
...
### [328] [A hyperboloidal method for numerical simulations of multidimensional nonlinear wave equations](https://arxiv.org/abs/2507.00674)
*Oliver Rinne*

Main category: math.NA

TL;DR: 论文研究了n+1维空间中具有幂次非线性的标量波动方程，突破了以往仅考虑径向对称性的限制，采用超双曲面叶层和共形紧化方法，计算了不同球谐模式下解的幂律衰减指数。


<details>
  <summary>Details</summary>
Motivation: 以往的研究多局限于径向对称性，本文旨在突破这一限制，研究更一般情况下的非线性波动方程的解的衰减行为。

Method: 采用超双曲面叶层和共形紧化方法，对n=3时不假设任何对称性，高维时仅施加SO(n-1)对称性。

Result: 计算了不同球谐模式下解的幂律衰减指数，涵盖了亚临界、临界和超临界情况下的聚焦和散焦非线性波动方程。

Conclusion: 通过非对称性假设和新的数值方法，本文为非线性波动方程的衰减行为提供了更全面的理解。
...
### [329] [An inverse-free fixed-time stable dynamical system and its forward-Euler discretization for solving generalized absolute value equations](https://arxiv.org/abs/2507.00531)
*Xuehua Li,Linjie Chen,Dongmei Yu,Cairong Chen,Deren Han*

Main category: math.NA

TL;DR: 提出无逆动态系统求解GAVE，固定时间内收敛，并给出离散迭代方法的收敛条件。


<details>
  <summary>Details</summary>
Motivation: 解决广义绝对值方程（GAVE）的求解问题，特别是在固定时间内收敛的需求。

Method: 提出了一种无逆动态系统，并通过前向欧拉离散化得到迭代方法。

Result: 动态系统在固定时间内收敛，且离散迭代方法在有限步数内全局收敛到解的邻域。

Conclusion: 该论文提出了一种无逆动态系统，能够在固定时间内求解广义绝对值方程（GAVE），且收敛时间对所有初始点都是有限且均匀有界的。此外，通过前向欧拉离散化得到的迭代方法，给出了保证离散迭代在有限步数内全局收敛到GAVE唯一解任意小邻域的充分条件。
...
### [330] [Isogeometric contact analysis in subsea umbilical and power cables](https://arxiv.org/abs/2507.00563)
*Tianjiao Dai,Shuo Yang,Xing Jin,Svein Sævik,Jiaxuan Zhang,Jun Wu,Naiquan Ye*

Main category: math.NA

TL;DR: 本文提出了一种等几何分析（IGA）方法，用于解决动态脐带缆和电力电缆中的接触问题，并通过MATLAB实现和验证其准确性和效率。


<details>
  <summary>Details</summary>
Motivation: 传统分析方法或有限元方法在处理复杂接触界面时存在挑战，接触表面属性是数值模拟中最敏感的参数，因此需要一种新方法来提高预测的准确性和效率。

Method: 采用等几何分析（IGA）方法，包括几何描述、接触检测和惩罚函数的MATLAB实现，并与ABAQUS进行对比验证。

Result: IGA方法在动态脐带缆的钢管与外护套接触界面中表现出高准确性和效率，并讨论了元素细化、几何描述和惩罚因子对IGA的影响。

Conclusion: IGA方法在接触分析中具有显著优势，能够有效提高模拟的准确性和效率，适用于复杂接触界面的动态分析。
...
### [331] [Special measures of smoothness for approximation by sampling operators in $L_p(\Bbb{R}^d)$](https://arxiv.org/abs/2507.00667)
*Yurii Kolomoitsev*

Main category: math.NA

TL;DR: 提出了一种改进的平滑度度量方法，用于更准确地估计采样或插值算子的$L_p$误差，尤其适用于低平滑度函数。


<details>
  <summary>Details</summary>
Motivation: 传统平滑度度量方法在估计采样或插值算子的$L_p$误差时，尤其是对低平滑度函数，往往不够准确。

Method: 引入了一种改进的平滑度度量方法，通过使用平均算子来结合函数在采样点的局部行为。

Result: 获得了匹配的直接和逆误差估计，提出了$L_p$中采样算子收敛的准则，并研究了采样算子的平滑性质。

Conclusion: 该方法适用于多种经典算子，如Whittaker-Shannon采样算子、$B$-样条生成的采样算子和高斯基采样算子。
...
### [332] [High order global flux schemes for general steady state preservation of shallow water moment equations with non-conservative products](https://arxiv.org/abs/2507.00573)
*Mirco Ciallella,Julian Koellermeier*

Main category: math.NA

TL;DR: 本文提出了一种针对浅水矩方程的高阶WENO有限体积方法，能够在没有解析稳态解的情况下保持所有稳态解。


<details>
  <summary>Details</summary>
Motivation: 浅水矩方程由于非保守项的引入，使得稳态解的解析分析变得困难，这对设计平衡格式提出了挑战。

Method: 采用基于通量全局化的方法，将源项和非保守项整合到高阶求积中，重构全局通量而非保守变量。

Result: 数值测试表明该方法具有最优收敛性，并能显著减少稳态解的误差。

Conclusion: 该方法适用于一般方程，无需稳态解的预先知识，具有较高的灵活性和准确性。
...
### [333] [Global well-posedness and Asymptotic analysis of a nonlinear heat equation with constraints of finite codimension](https://arxiv.org/abs/2507.00160)
...
### [334] [$L^p$ Estimates for Eigenfunctions of a Generalized Landau Magnetic Laplacian](https://arxiv.org/abs/2507.00183)
...
### [335] [Multiple solutions for Schr{ö}dinger-Poisson-Slater equations with critical growth](https://arxiv.org/abs/2507.00295)
*Shibo Liu*
...
### [336] [Existence and spectral stability analysis of viscous-dispersive shock profiles for isentropic compressible fluids of Korteweg type](https://arxiv.org/abs/2507.00374)
...
### [337] [Existence and multiplicity of normalized solutions for the quasi-linear Schrödinger equations with mixed nonlinearities](https://arxiv.org/abs/2507.00375)
*Qihan He,Hao Wang*
...
### [338] [Dynamics of 3D focusing, energy-critical wave equation with radial data](https://arxiv.org/abs/2507.00391)
*Ruipeng Shen*
...
### [339] [Standing wave solutions of $abcd$-systems for water waves](https://arxiv.org/abs/2507.00436)
...
### [340] [Inviscid incompressible limit for capillary fluids with density dependent viscosity](https://arxiv.org/abs/2507.00621)
...
### [341] [Normalized ground states for NLS equations with mass critical nonlinearities](https://arxiv.org/abs/2507.00639)
...
### [342] [A convex lifting approach for the Calderón problem](https://arxiv.org/abs/2507.00645)
...
### [343] [Quantitative homogenization of convex Hamilton-Jacobi equations with $u/\varepsilon$-periodic Hamiltonians](https://arxiv.org/abs/2507.00663)
...
### [344] [Closed Estimates of Leray Projected Transport Noise and Strong Solutions of the Stochastic Euler Equations](https://arxiv.org/abs/2507.00787)
*Daniel Goodair*
...
### [345] [Deducing the Talbot Effect from Electrodynamics](https://arxiv.org/abs/2507.00820)
...
### [346] [Multi-peak solutions for the fractional Schrödinger equation with Dirichlet datum](https://arxiv.org/abs/2507.00806)
...
### [347] [The strong log-concavity for first eigenfunction of the Ornstein-Uhlenbeck operator in the class of convex bodies](https://arxiv.org/abs/2507.00819)
*Lei Qin*
...
### [348] [Magnetic Stabilization of Compressible Flows: Global Existence in 3D Inviscid Non-Isentropic MHD Equations](https://arxiv.org/abs/2507.00888)
...
### [349] [Existence and stability of Sadovskii vortices: from vortex patches to regular vorticity](https://arxiv.org/abs/2507.00910)
...
### [350] [Doubly nonlinear parabolic equation involving a mixed local-nonlocal operator and a convection term](https://arxiv.org/abs/2507.00959)
...
### [351] [Besov mixed-Morrey spaces: On an Application to the Navier-Stokes Equations](https://arxiv.org/abs/2507.00970)
...
### [352] [Stable skeleton integral equations for general coefficient Helmholtz transmission problems](https://arxiv.org/abs/2507.00991)
...
### [353] [Global well-posedness and Asymptotic analysis of a nonlinear heat equation with constraints of finite codimension](https://arxiv.org/abs/2507.00160)
*Ashish Bawalia,Zdzisław Brzeźniak,Manil T. Mohan*

Main category: math.AP

TL;DR: 本文证明了在任意维度$d\geq1$的有界域上，非线性热方程在约束条件下的$L^p\cap H_0^1$值强解的全局存在性和唯一性。
...
Method: 采用Faedo-Galerkin逼近方法和紧性论证，利用非线性算子的单调性和半连续性性质。

Result: 证明了约束条件的Hilbert流形$\mathbb{M}$是不变的，并推广了阻尼非线性情况下的渐近分析结果。

Conclusion: 对于正初始数据，非线性热方程的强解在$L^p\cap H_0^1$中收敛到唯一的正基态解。
...
### [354] [$L^p$ Estimates for Eigenfunctions of a Generalized Landau Magnetic Laplacian](https://arxiv.org/abs/2507.00183)
*Ben Gabriel Goldschlager*

Main category: math.AP

TL;DR: 研究了广义Landau磁拉普拉斯算子的本征函数，证明了在一般条件下，其$L^\infty$范数由$L^2$范数控制，且改进了$L^6$范数的估计。


<details>
  <summary>Details</summary>
Motivation: 探讨电子在磁场中受限时的物理模型，特别是本征函数的性质。

Method: 采用半经典分析方法，结合新的共轭论证，推广了Koch、Tataru和Zworski的局部结果到全局。

Result: 证明了本征函数的$L^\infty$范数独立于特征值，且$L^6$范数有改进。

Conclusion: 该方法为磁场中电子行为的全局分析提供了新工具。
...
### [355] [Multiple solutions for Schr{ö}dinger-Poisson-Slater equations with critical growth](https://arxiv.org/abs/2507.00295)
*Shibo Liu*

Main category: math.AP

TL;DR: 论文研究了零质量Schrödinger-Poisson-Slater方程的多解问题，通过简化方法验证了(PS)_c条件，并在大参数λ下获得了多重解。


<details>
  <summary>Details</summary>
Motivation: 研究零质量Schrödinger-Poisson-Slater方程的多解问题，特别是在大参数λ下的解的存在性和多重性。

Method: 使用简化方法验证(PS)_c条件，并结合变分法和临界点理论。

Result: 在λ足够大时，证明了方程存在多个解，并推广到带有外部势的相关方程。

Conclusion: 通过简化方法成功验证了(PS)_c条件，为类似问题提供了新的解决思路。
...
### [356] [Existence and spectral stability analysis of viscous-dispersive shock profiles for isentropic compressible fluids of Korteweg type](https://arxiv.org/abs/2507.00374)
*R. Folino,C. Lattanzio,R. G. Plaza*

Main category: math.AP

TL;DR: The paper studies a compressible fluid system with viscosity and capillarity, proving existence and stability of traveling wave solutions under general conditions.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore the dynamics of compressible isentropic fluids with viscosity and internal capillarity, focusing on the existence and stability of traveling wave solutions.

Method: The study employs nonlinear smooth functions for viscosity and capillarity coefficients, analyzes traveling wave solutions, and uses spectral stability analysis with energy estimates.

Result: The results show the existence of unique traveling wave solutions satisfying classical conditions, with spectral stability confirmed under specific amplitude and structural constraints.

Conclusion: The paper concludes that the system admits unique traveling wave solutions (viscous-dispersive shock profiles) under general conditions, and these solutions are spectrally stable under certain amplitude and structural constraints.
...
### [357] [Existence and multiplicity of normalized solutions for the quasi-linear Schrödinger equations with mixed nonlinearities](https://arxiv.org/abs/2507.00375)
*Qihan He,Hao Wang*

Main category: math.AP

TL;DR: 本文研究了准线性问题中归一化解的存在性和多重性，补充了Lu等人和Jeanjean等人的工作。


<details>
  <summary>Details</summary>
Motivation: 研究准线性问题中归一化解的存在性和多重性，填补现有文献的空白。

Method: 通过分析质量混合情况下的参数范围，证明归一化基态解和山道型解的存在性。

Result: 证明了归一化基态解和山道型解的存在性。

Conclusion: 本文结果为相关领域的研究提供了补充，扩展了现有理论。
...
### [358] [Dynamics of 3D focusing, energy-critical wave equation with radial data](https://arxiv.org/abs/2507.00391)
*Ruipeng Shen*

Main category: math.AP

TL;DR: 本文研究了三维空间中能量临界波方程的径向解的长时间动力学，证明了定量版本的孤子分解结果。


<details>
  <summary>Details</summary>
Motivation: 探讨能量临界波方程的长时间行为，特别是孤子分解的定量结果。

Method: 利用波方程的辐射理论，并观察到辐射与孤子碰撞行为之间的对应关系。

Result: 证明了定量版本的孤子分解结果，适用于所有时间t>0的解。

Conclusion: 通过辐射理论与孤子碰撞行为的对应关系，成功描述了长时间动力学行为。
...
### [359] [Standing wave solutions of $abcd$-systems for water waves](https://arxiv.org/abs/2507.00436)
*Peifei Song,Yuhao Xie,Min Chen,Shenghao Li*

Main category: math.AP

TL;DR: 本文通过Lyapunov-Schmidt方法研究了$abcd$系统的驻波解，证明了Bona-Smith系统的非平凡分岔解存在性，并将系统分为三类。


<details>
  <summary>Details</summary>
Motivation: 继续Chen和Iooss对BBM系统驻波解的研究，探讨Lyapunov-Schmidt方法在$abcd$系统中的适用性。

Method: 使用Lyapunov-Schmidt方法分析$abcd$系统的分岔驻波解。

Result: 证明了Bona-Smith系统存在非平凡分岔驻波解，并对$abcd$系统进行了分类。

Conclusion: 本文证明了Bona-Smith系统存在非平凡分岔驻波解，并将$abcd$系统分为可行、不可行和不确定可行三类。
...
### [360] [Inviscid incompressible limit for capillary fluids with density dependent viscosity](https://arxiv.org/abs/2507.00621)
*Matteo Caggio,Donatella Donatelli,Lars Eric Hientzsch*

Main category: math.AP

TL;DR: 本文研究了2D和3D Navier-Stokes-Korteweg系统在低马赫数和黏度消失条件下的渐近极限，证明了弱解向不可压缩Euler系统强解的收敛性。


<details>
  <summary>Details</summary>
Motivation: 研究密度依赖黏度的毛细流体在特定条件下的渐近行为，为理解复杂流体动力学提供理论支持。

Method: 采用相对能量框架，结合Korteweg张量修正的声学系统分散估计，证明弱解向强解的收敛性。

Result: 在低马赫数和黏度消失条件下，Navier-Stokes-Korteweg系统的弱解收敛于不可压缩Euler系统的强解。

Conclusion: 通过理论分析，验证了在特定条件下Navier-Stokes-Korteweg系统与不可压缩Euler系统之间的渐近关系。
...
### [361] [Normalized ground states for NLS equations with mass critical nonlinearities](https://arxiv.org/abs/2507.00639)
*Silvia Cingolani,Marco Gallo,Norihisa Ikoma,Kazunaga Tanaka*

Main category: math.AP

TL;DR: 论文研究了具有L²临界增长的非线性薛定谔方程的归一化解，探讨了不同情况下的极小极大值，并讨论了存在性和非存在性条件。


<details>
  <summary>Details</summary>
Motivation: 研究非线性薛定谔方程的归一化解，特别是在L²临界增长条件下，以填补现有文献中对不同参数情况的讨论空白。

Method: 通过分析拉格朗日泛函的极小极大值，构造具体的函数g，验证不同情况下的解的存在性和非存在性。

Result: 给出了满足不同条件的函数g的显式例子，并讨论了最小能量解的存在性以及正解的存在条件。

Conclusion: 论文扩展了非线性薛定谔方程归一化解的理论框架，为未来研究提供了新的方向和工具。
...
### [362] [A convex lifting approach for the Calderón problem](https://arxiv.org/abs/2507.00645)
*Giovanni S. Alberti,Romain Petit,Simone Sanna*

Main category: math.AP

TL;DR: 论文提出了一种基于提升和凸松弛技术的新方法，用于解决Calderón问题中的非线性逆问题，避免了局部收敛问题。


<details>
  <summary>Details</summary>
Motivation: Calderón问题中的非线性前向算子导致重建方法通常面临局部收敛的挑战，需要一种更稳定的解决方案。

Method: 采用提升和凸松弛技术，将问题转化为凸优化问题，确保解与目标系数一致（在非退化源条件下）。

Result: 在简化模型中验证了方法的有效性，并证明了非退化源条件在特定假设下成立。

Conclusion: 该方法为Calderón问题提供了一种潜在解决方案，但需进一步验证其在更复杂场景中的适用性。
...
### [363] [Quantitative homogenization of convex Hamilton-Jacobi equations with $u/\varepsilon$-periodic Hamiltonians](https://arxiv.org/abs/2507.00663)
*Hiroyoshi Mitake,Panrui Ni,Hung V. Tran*

Main category: math.AP

TL;DR: 本文研究了具有周期性哈密顿量的凸哈密顿-雅可比方程的定量均匀化问题，通过基本解和隐式变分原理建立了最优收敛速度，并在额外增长条件下证明了全局Hölder正则性。


<details>
  <summary>Details</summary>
Motivation: 研究动机源于位错动力学中常见的周期性哈密顿量问题，旨在通过定量均匀化理论解决其收敛性和正则性问题。

Method: 方法包括利用基本解和隐式变分原理分析哈密顿动力学，并在额外增长条件下研究解的全局Hölder正则性。

Result: 结果表明，该方法能够建立最优收敛速度，并在特定条件下证明解和校正子的全局Hölder正则性。

Conclusion: 本文通过定量均匀化理论，为周期性哈密顿量的凸哈密顿-雅可比方程提供了收敛性和正则性的理论支持。
...
### [364] [Closed Estimates of Leray Projected Transport Noise and Strong Solutions of the Stochastic Euler Equations](https://arxiv.org/abs/2507.00787)
*Daniel Goodair*

Main category: math.AP

TL;DR: 论文研究了三维环面上不可压缩的欧拉和纳维-斯托克斯方程，通过引入随机噪声（传输或传输-拉伸噪声），证明了在任意正整数阶Sobolev空间和Stokes空间中噪声贡献的能量估计的封闭控制。首次得到了对应随机欧拉方程的局部强解存在性，并证明了光滑解在$L^1\left([0,T];W^{1,\infty}\right)$中直到爆破的存在性。


<details>
  <summary>Details</summary>
Motivation: 研究随机噪声对不可压缩欧拉和纳维-斯托克斯方程的影响，特别是在高维空间中噪声控制的困难性，以及如何克服Leray投影对高阶导数抵消的干扰。

Method: 通过引入传输或传输-拉伸Stratonovich噪声，利用能量估计方法在Sobolev和Stokes空间中控制噪声贡献，并处理Leray投影带来的挑战。

Result: 首次证明了随机欧拉方程的局部强解存在性，并展示了光滑解在特定空间中直到爆破的存在性。

Conclusion: 随机噪声的引入为不可压缩欧拉和纳维-斯托克斯方程的解提供了新的理论支持，特别是在高维空间中的控制和解的存在性方面。
...
### [365] [Deducing the Talbot Effect from Electrodynamics](https://arxiv.org/abs/2507.00820)
*Gabriel Ybarra Marcaida*

Main category: math.AP

TL;DR: A Maxwell-based model for the Talbot effect is proposed, analytically solved, and shown to match literature results asymptotically, with derived ideal distributions and proof of convergence.


<details>
  <summary>Details</summary>
Motivation: The motivation is to provide a comprehensive model for the Talbot effect using Maxwell's equations, showcasing its universal applicability.

Method: The method involves solving the proposed model analytically, proving its equivalence to existing literature in the asymptotic limit, and deriving an ideal paraxial distribution for the rational Talbot effect.

Result: The results include the proof of $L^2$ convergence to ideal distributions for any grating and the derivation of the rational Talbot effect in the paraxial limit.

Conclusion: The paper concludes that the proposed model based on Maxwell's equations successfully describes the Talbot effect, demonstrating its universal nature and relevance for various physical systems and technological applications.
...
### [366] [Multi-peak solutions for the fractional Schrödinger equation with Dirichlet datum](https://arxiv.org/abs/2507.00806)
*Maria Medina,Jing Wu*

Main category: math.AP

TL;DR: 论文研究了在特定条件下，具有Dirichlet边界条件的非线性分数阶方程的多峰解的存在性，并分析了解的集中现象。


<details>
  <summary>Details</summary>
Motivation: 研究分数阶方程的多峰解及其在临界点附近的集中行为，以理解解的构造和潜在的非线性现象。

Method: 采用Lyapunov-Schmidt约简方法，结合精确的渐近展开，控制势能、边界和峰之间的相互作用。

Result: 证明了在非退化临界点附近存在多峰解，并分析了在局部极值点附近的聚类现象的存在性与非存在性。

Conclusion: 通过精确的渐近分析，成功构造了多峰解，并揭示了势能对解集中行为的影响。
...
### [367] [Some geometric and spectral aspects of restriction problems](https://arxiv.org/abs/2507.00204)
...
### [368] [Uncertainty principles associated with the linear canonical Dunkl transform](https://arxiv.org/abs/2507.00530)
...
### [369] [Non-spectrality of some piecewise smooth curves and unions of line segments](https://arxiv.org/abs/2507.00581)
...
### [370] [Bounded common fundamental domains for two lattices](https://arxiv.org/abs/2507.00604)
...
### [371] [An Algebraic Proof of Weierstrass's Approximation Theorem](https://arxiv.org/abs/2507.00834)
...
### [372] [Block structure in boolean matrices of bounded factorization norm](https://arxiv.org/abs/2507.00872)
...
### [373] [Some geometric and spectral aspects of restriction problems](https://arxiv.org/abs/2507.00204)
*Hajer Bahouri,Veronique Fischer*

Main category: math.CA

TL;DR: 纪念Haim Brezis并探讨限制问题与谱和几何分析的联系，基于其多领域贡献。


<details>
  <summary>Details</summary>
Motivation: Brezis在多个领域（如调和分析、偏微分方程、谱理论等）对限制问题有重要贡献，因此选择此主题。

Method: 通过分析限制问题在谱分析和几何分析中的应用，结合Brezis的贡献。

Result: 探讨了限制问题与谱和几何分析的联系，并纪念了Brezis的学术遗产。

Conclusion: 本文纪念Haim Brezis并探讨了限制问题的某些方面，特别是其与谱分析和几何分析的联系。
...
### [374] [Uncertainty principles associated with the linear canonical Dunkl transform](https://arxiv.org/abs/2507.00530)
*Umamaheswari S,Sandeep Kumar Verma*

Main category: math.CA

TL;DR: 本文在线性规范Dunkl变换框架下建立了Miyachi、Cowling-Price和Heisenberg-Pauli-Weyl不确定性原理的类比，并获得了Nash、Clarkson、Donoho-Stark和Matolcsi-Szucs类型的加权不等式。


<details>
  <summary>Details</summary>
Motivation: 研究线性规范Dunkl变换框架下的不确定性原理及其相关加权不等式。

Method: 建立Miyachi、Cowling-Price和Heisenberg-Pauli-Weyl不确定性原理的类比，并推导加权不等式。

Result: 成功建立了不确定性原理的类比，并获得了多种类型的加权不等式。

Conclusion: 在线性规范Dunkl变换框架下，不确定性原理及其相关加权不等式的研究取得了重要进展。
...
### [375] [Non-spectrality of some piecewise smooth curves and unions of line segments](https://arxiv.org/abs/2507.00581)
*Mihail N. Kolountzakis,Chun-Kit Lai*

Main category: math.CA

TL;DR: The paper proves that certain arc-length measures on curves (e.g., closed polygons, smooth convex curves with self-intersections) are not spectral, and discusses open questions in this area.


<details>
  <summary>Details</summary>
Motivation: The motivation is to systematically investigate the spectrality of measures supported on piecewise smooth curves, particularly focusing on singular spectral measures.

Method: The study involves analyzing the support of tempered distributions arising from the tiling equation of singular spectral measures.

Result: The results show that arc-length measures on closed polygonal lines, smooth convex curves with finitely many transverse self-intersections, and the 'plus space' are not spectral.

Conclusion: The paper concludes that arc-length measures on closed polygonal lines, smooth convex curves with finitely many transverse self-intersections, and the 'plus space' are not spectral. It also highlights open questions about the spectrality of singular measures and piecewise smooth curves.
...
### [376] [Bounded common fundamental domains for two lattices](https://arxiv.org/abs/2507.00604)
*Sigrid Grepstad,Mihail N. Kolountzakis*

Main category: math.CA

TL;DR: 证明了对于任意两个体积相同的格点L和M，存在一个有界可测的共同基本域E，E可以表示为有限多面体的并集。


<details>
  <summary>Details</summary>
Motivation: 研究格点之间的共同基本域的存在性及其性质。

Method: 通过构造有界可测集E，证明其可以作为L和M的共同基本域。

Result: 存在一个有限多面体的并集E，能够作为L和M的共同基本域，并且其指示函数在L^2空间中形成正交基。

Conclusion: 证明了共同基本域的存在性及其在Gabor正交基中的应用。
...
### [377] [An Algebraic Proof of Weierstrass's Approximation Theorem](https://arxiv.org/abs/2507.00834)
*José M. González Barrios,Alberto Contreras-Cristán,Patricia I. Romero-Mares*

Main category: math.CA

TL;DR: 利用Vandermonde矩阵及其性质，为Weierstrass的连续函数多项式逼近定理提供了新的证明方法。


<details>
  <summary>Details</summary>
Motivation: 探索通过Vandermonde矩阵的线性系统解法，简化Weierstrass逼近定理的证明过程。

Method: 利用Vandermonde矩阵的非零行列式性质，构建多项式序列逼近连续函数。

Result: 成功构造了逼近连续函数的多项式序列，并展示了其与泰勒级数的联系。

Conclusion: 该方法不仅简化了经典定理的证明，还揭示了多项式逼近与泰勒级数之间的代数关系。
...
### [378] [Block structure in boolean matrices of bounded factorization norm](https://arxiv.org/abs/2507.00872)
*Marcel K. Goh,Hamed Hatami*

Main category: math.CA

TL;DR: 论文证明具有有限γ2范数的布尔矩阵存在一个块状矩阵B，其1-条目数量至少为A的指数分之一。


<details>
  <summary>Details</summary>
Motivation: 研究布尔矩阵的性质及其与块状矩阵的关系，以理解γ2范数在矩阵分析中的作用。

Method: 通过构造块状矩阵B，并证明其与给定布尔矩阵A的关系。

Result: 对于γ2范数不超过λ的布尔矩阵A，存在一个块状矩阵B，满足B(i,j)=1仅当A(i,j)=1，且B的1-条目数量至少为A的1/2^{2^{O(λ)}}倍。

Conclusion: 论文证明了对于任何具有有限γ2范数的布尔矩阵，存在一个块状矩阵B，其1-条目数量至少为A的1/2^{2^{O(λ)}}倍。
...
### [379] [Disentangled Feature Importance](https://arxiv.org/abs/2507.00260)
...
### [380] [Enhancing Interpretability in Generative Modeling: Statistically Disentangled Latent Spaces Guided by Generative Factors in Scientific Datasets](https://arxiv.org/abs/2507.00298)
...
### [381] [GRAND: Graph Release with Assured Node Differential Privacy](https://arxiv.org/abs/2507.00402)
...
### [382] [Forward Reverse Kernel Regression for the Schrödinger bridge problem](https://arxiv.org/abs/2507.00640)
...
### [383] [An in depth look at the Procrustes-Wasserstein distance: properties and barycenters](https://arxiv.org/abs/2507.00894)
...
### [384] [Disentangled Feature Importance](https://arxiv.org/abs/2507.00260)
*Jin-Hong Du,Kathryn Roeder,Larry Wasserman*

Main category: stat.ML

TL;DR: DFI是一种通过最优传输消除特征相关性的新型特征重要性量化方法，解决了传统方法低估相关特征贡献的问题。


<details>
  <summary>Details</summary>
Motivation: 传统特征重要性量化方法在特征相关时会系统性低估贡献，需要一种能消除相关性影响的新方法。

Method: 通过最优传输将相关特征转换为独立隐变量，在解耦空间中计算重要性并通过传输映射的敏感性回传。

Result: DFI提供了重要性得分的理论分解，实现了根号n一致性和渐近正态性，且计算高效。

Conclusion: DFI是一种理论严谨、计算高效的特征重要性量化框架，适用于任意特征依赖关系。
...
### [385] [Enhancing Interpretability in Generative Modeling: Statistically Disentangled Latent Spaces Guided by Generative Factors in Scientific Datasets](https://arxiv.org/abs/2507.00298)
*Arkaprabha Ganguli,Nesar Ramachandra,Julie Bessac,Emil Constantinescu*

Main category: stat.ML

TL;DR: Aux-VAE是一种改进的变分自编码器，通过辅助变量实现潜在变量的解耦，适用于高维数据的非线性降维。


<details>
  <summary>Details</summary>
Motivation: 解决在高维数据中无监督或半监督条件下统计提取生成因子的挑战。

Method: 提出Aux-VAE架构，利用辅助变量引导潜在空间的形成，仅需对标准VAE损失函数进行微小修改。

Result: 在多个数据集（包括天文模拟）上验证了Aux-VAE的有效性。

Conclusion: Aux-VAE通过辅助变量成功实现潜在变量的解耦，为高维数据分析提供了新方法。
...
### [386] [GRAND: Graph Release with Assured Node Differential Privacy](https://arxiv.org/abs/2507.00402)
*Suqing Liu,Xuan Bi,Tianxi Li*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法在节点级隐私保护中要么局限于查询方式，要么无法保留网络结构。

Method: 提出GRAND机制，在潜在空间模型下确保节点级差分隐私并保留结构属性。

Result: 实验证明GRAND在合成和真实数据集上有效，发布的网络与原网络分布一致。
...
### [387] [Forward Reverse Kernel Regression for the Schrödinger bridge problem](https://arxiv.org/abs/2507.00640)
*Denis Belomestny,John. Schoenmakers*

Main category: stat.ML

TL;DR: 本文提出了一种非参数化的蒙特卡洛方法，用于近似薛定谔桥问题中的势函数，证明了算法的收敛性并提供了最优收敛速率。


<details>
  <summary>Details</summary>
Motivation: 研究薛定谔桥问题在熵最优传输中的核心作用，并解决一般参考过程和端点分布下的势函数近似问题。

Method: 提出了一种前向-反向迭代蒙特卡洛方法，结合核基蒙特卡洛回归和Picard迭代，用于近似薛定谔势函数。

Result: 开发了一种可证明收敛的算法，并提供了势估计的收敛速率及其最优性证明。

Conclusion: 本文提出了一种非参数化的蒙特卡洛方法，用于近似薛定谔桥问题中的势函数，并通过保持正性和希尔伯特度量下的收缩性，证明了算法的收敛性。此外，还提供了势估计的收敛速率并证明了其最优性。
...
### [388] [An in depth look at the Procrustes-Wasserstein distance: properties and barycenters](https://arxiv.org/abs/2507.00894)
*Davide Adamo,Marco Corneli,Manon Vuillien,Emmanuelle Vila*

Main category: stat.ML

TL;DR: PW距离是一种对刚体变换不变的最优传输距离，适用于点云对齐和比较。本文扩展了PW框架，提出PW重心算法，并在考古学中验证了其有效性。
...
Method: 构建离散概率度量空间，证明PW是距离，并扩展PW框架，包括初始化策略和PW重心算法。

Result: PW方法在精确对齐和形状保持方面优于现有OT方法，并在考古学应用中展示了实用性。

Conclusion: PW距离在机器学习和计算几何应用中具有潜力，特别是在需要精确对齐和形状保持的场景中。
...
### [389] [Dissociation limits in Density Functional Theory](https://arxiv.org/abs/2507.00063)
...
### [390] [Covariant Lie Derivatives and (Super-)Gravity](https://arxiv.org/abs/2507.00140)
...
### [391] [Random walks in a field of soft traps and criticality for the dissipative Abelian Sandpile Model](https://arxiv.org/abs/2507.00562)
...
### [392] [Tables of practical invariants for distinguishing multiplicity-free fusion categories up to rank 7](https://arxiv.org/abs/2507.00652)
*Gert Vercleyen*
...
### [393] [A coupled multiscale model of the human cornea accounting for the collagenous microstructure and the extracellular matrix](https://arxiv.org/abs/2507.00668)
...
### [394] [Renormalization group based implicit function approach to connecting orbits](https://arxiv.org/abs/2507.00749)
...
### [395] [Lecture Notes on Operator Algebras and Quantum Field Theory](https://arxiv.org/abs/2507.00900)
*Rainer Verch*
...
### [396] [Dissociation limits in Density Functional Theory](https://arxiv.org/abs/2507.00063)
*Guy Bouchitté,Giuseppe Buttazzo,Thierry Champion,Luigi De Pascale*

Main category: math-ph

TL;DR: 论文研究了密度泛函理论中极小化子的渐近行为，证明了在ε趋近于零时，极小化子表现为Dirac质量的叠加，并给出了显式表达式。


<details>
  <summary>Details</summary>
Motivation: 研究密度泛函理论中极小化子的渐近行为，特别是在电子与核相互作用较弱时可能发生的电离现象。

Method: 采用Γ-极限方法，分析了极小化子Fε在ε趋近于零时的行为，并推导出极限泛函的显式表达式。

Result: 证明了极小化子的Γ-极限泛函定义在Dirac质量的叠加上，并给出了其显式表达式，具体依赖于模型中的动能、电子排斥关联和势能相互作用项。

Conclusion: 论文通过研究密度泛函理论框架下的极小化问题，揭示了在参数ε趋近于零时，极小化子的渐近行为表现为Dirac质量的叠加，并给出了具体的表达式。
...
### [397] [Covariant Lie Derivatives and (Super-)Gravity](https://arxiv.org/abs/2507.00140)
*Grigorios Giotopoulos*

Main category: math-ph

TL;DR: 论文提供了关于协变Lie导数的完整数学描述，并应用于超引力中的两个重要例子。


<details>
  <summary>Details</summary>
Motivation: 文献中关于协变Lie导数的讨论零散，而这一概念在物理学中至关重要。

Method: 通过选择主丛上的提升或协变修正项来定义协变Lie导数。

Result: 详细展示了两个协变Lie导数的例子，并解决了非平凡时空中的维度约简问题。

Conclusion: 论文填补了文献空白，为协变Lie导数的应用提供了严格数学基础。
...
### [398] [Random walks in a field of soft traps and criticality for the dissipative Abelian Sandpile Model](https://arxiv.org/abs/2507.00562)
*Frank Redig,Berend van Tol,Ellen Saada*

Main category: math-ph

TL;DR: 论文研究了在一维随机行走中软陷阱的临界增长速率，揭示了其与耗散阿贝尔沙堆模型临界性的关系。


<details>
  <summary>Details</summary>
Motivation: 受耗散阿贝尔沙堆模型的启发，研究随机行走在软陷阱景观中的轨迹，以理解耗散对模型临界性的影响。

Method: 分析一维随机行走在间隔逐渐增大的软陷阱中的行为，确定临界增长速率。

Result: 发现临界增长速率导致随机行走预期生存时间的有限性与非有限性之间的转变，对应耗散阿贝尔沙堆模型的非临界性与临界性。

Conclusion: 精确量化了原始阿贝尔沙堆模型中可添加的耗散量，以破坏其临界性。
...
### [399] [Tables of practical invariants for distinguishing multiplicity-free fusion categories up to rank 7](https://arxiv.org/abs/2507.00652)
*Gert Vercleyen*

Main category: math-ph

TL;DR: 本文探讨了Anyonica软件包和anyonwiki网站提出的秩7以下无多重性融合范畴普查是否可视为正确分类，并讨论了正确性和完备性问题。


<details>
  <summary>Details</summary>
Motivation: 研究目的是验证Anyonica和anyonwiki提供的无多重性融合范畴分类的正确性和完备性。

Method: 通过提供这些小范畴的不变量表，手动验证其自同构下的不变性及范畴间的（不）等价性。

Result: 在假设所有数据正确的前提下，解决了范畴不等价性问题，并提供了识别对应范畴的方法。

Conclusion: 通过手动验证不变量，可以确认Anyonica和anyonwiki的分类在秩7以下是可靠的。
...
### [400] [A coupled multiscale model of the human cornea accounting for the collagenous microstructure and the extracellular matrix](https://arxiv.org/abs/2507.00668)
*Christopher Miller,Maria Laura De Bellis,Anna Pandolfi*

Main category: math-ph

TL;DR: 提出了一种基于微观结构的角膜有限元模型，通过分离连续相与胶原微观结构，更准确地模拟了角膜病理状态下的行为。
...
Method: 采用非线性桁架结构描述胶原交联网络，并用连续固体元素描述细胞外蛋白多糖基质，将角膜视为具有强非线性特性的复合材料。

Result: 通过将连续相与胶原微观结构分离，模型能够更准确地模拟角膜在病理状态下的行为。

Conclusion: 该论文提出了一种基于微观结构的有限元模型，能够更真实地捕捉角膜在病理状态下的宏观现象，如局部变形。
...
### [401] [Renormalization group based implicit function approach to connecting orbits](https://arxiv.org/abs/2507.00749)
*Pengfei Guo,Yueheng Lan,Jianyong Qiao*

Main category: math-ph

TL;DR: 基于重整化群方法，设计了一种隐函数方案，用于有效表示不同类型连接轨道的统一解析近似，简化了计算过程。


<details>
  <summary>Details</summary>
Motivation: 连接轨道是非线性系统状态空间中的重要不变结构，但对其整体解析近似的研究较少。

Method: 利用重整化群设计隐函数方案，通过线性代数方程组简化计算，并通过最小化误差函数确定未知系统参数。

Result: 在五个常见例子中近似或精确地找到了同宿或异宿连接，验证了新方案的有效性。

Conclusion: 新方案通过统一解析近似和简化计算，有效解决了连接轨道的计算问题，并展示了其在实际应用中的潜力。
...
### [402] [Lecture Notes on Operator Algebras and Quantum Field Theory](https://arxiv.org/abs/2507.00900)
*Rainer Verch*

Main category: math-ph

TL;DR: 这是一组关于量子场论中对称性和测量的讲座笔记，涵盖算子代数、Tomita-Takesaki模理论、局部协变量子场论以及黑洞附近量子场的温度和熵-面积关系。
...
Method: 通过四场讲座，分别探讨算子代数与量子场论、Tomita-Takesaki模理论、局部协变量子场论以及黑洞附近的量子场性质。

Result: 讲座展示了算子代数框架下的量子场论方法，并应用于黑洞热力学和信息内容的研究。

Conclusion: 这些讲座为量子场论中的对称性和测量提供了理论基础，并展示了其在黑洞物理中的实际应用。
...
### [403] [Confocal Raman microscopy inside sessile multicomponent droplets](https://arxiv.org/abs/2507.00208)
...
### [404] [Propulsion and interaction of wave-propelled interfacial particles](https://arxiv.org/abs/2507.00247)
...
### [405] [Guided Unconditional and Conditional Generative Models for Super-Resolution and Inference of Quasi-Geostrophic Turbulence](https://arxiv.org/abs/2507.00719)
...
### [406] [A network-theoretic approach for characterizing Mack-mode instability in high-speed boundary layers](https://arxiv.org/abs/2507.00370)
...
### [407] [Nonlinear projection-based model order reduction with machine learning regression for closure error modeling in the latent space](https://arxiv.org/abs/2507.00634)
...
### [408] [Minimum-enstrophy and maximum-entropy equilibrium states in two-dimensional topographic turbulence](https://arxiv.org/abs/2507.00691)
*Jiyang He,Yan Wang*
...
### [409] [Aerodynamic consequences of wing damage in dragonflies](https://arxiv.org/abs/2507.00713)
...
### [410] [A simplified unified wave-particle method for diatomic gases with rotational and vibrational non-equilibrium](https://arxiv.org/abs/2507.00720)
...
### [411] [Insight into the combustion dynamics of ITA-driven swirl flames](https://arxiv.org/abs/2507.00764)
...
### [412] [Evaporation of sessile drops on a heated superhydrophobic substrate](https://arxiv.org/abs/2507.00774)
...
### [413] [Magnetic control of metafluids for fluid-like applications of metamaterials](https://arxiv.org/abs/2507.00857)
...
### [414] [On a mathematical definition of laminar and turbulent fluid flow](https://arxiv.org/abs/2507.00974)
...
### [415] [Confocal Raman microscopy inside sessile multicomponent droplets](https://arxiv.org/abs/2507.00208)
*Alexander Erb,Johanna Steinmann,Youngeun Lee,Robert W. Stark*

Main category: physics.flu-dyn

TL;DR: 该研究通过建模液滴折射效应，改进了拉曼显微镜测量多组分液滴蒸发浓度梯度的方法，并展示了其在技术应用中的潜力。


<details>
  <summary>Details</summary>
Motivation: 多组分液滴蒸发过程中的浓度梯度及其动力学机制尚未完全理解，且现有方法可能干扰液滴动态，因此需要高分辨率、无标记的测量方法。

Method: 研究通过建模液滴折射效应，分析了水平和垂直激光配置下的焦点偏移，并引入改进的水平激光配置进行拉曼测量。

Result: 模拟的液滴形状与测量结果吻合良好，水平激光配置适用于大接触角液滴的三相接触线区域分析。

Conclusion: 该研究为拉曼显微镜测量液滴提供了指导，有助于理解蒸发动力学，并为印刷、清洁和能源转换技术应用奠定了基础。
...
### [416] [Propulsion and interaction of wave-propelled interfacial particles](https://arxiv.org/abs/2507.00247)
*Daniel M. Harris,Jack-William Barotta*

Main category: physics.flu-dyn

TL;DR: 本文综述了通过振动驱动的浮体在流体界面上的自推进现象及其相互作用，展示了丰富的集体动力学行为，并探讨了其在流体力学、活性物质和机器人学等领域的潜在应用。


<details>
  <summary>Details</summary>
Motivation: 研究振动驱动的浮体在流体界面上的自推进现象及其相互作用，以揭示其动力学行为，并为流体力学、活性物质和机器人学等领域提供新的见解。

Method: 通过综述多个相关系统，分析振动驱动的浮体如何通过表面波实现自推进和相互作用。

Result: 发现浮体可以通过不对称波场实现自推进，并表现出直线运动、旋转或曲线运动等行为；这些浮体通过毛细波场相互作用，展现出丰富的集体动力学。

Conclusion: 这些系统不仅为流体力学的基础研究提供了新的方向，还可能推动活性物质、流体量子模拟和机器人学等领域的进展。
...
### [417] [Guided Unconditional and Conditional Generative Models for Super-Resolution and Inference of Quasi-Geostrophic Turbulence](https://arxiv.org/abs/2507.00719)
*Anantha Narayanan Suresh Babu,Akhil Sadam,Pierre F. J. Lermusiaux*

Main category: physics.flu-dyn

TL;DR: 本文研究了四种生成扩散模型在二维准地转湍流超分辨率和推断中的应用，比较了它们的性能、实现难度和一致性。


<details>
  <summary>Details</summary>
Motivation: 由于海洋、天气和气候的数值模拟通常较为粗糙，且观测数据稀疏且不完整，因此需要有效的方法从这些数据中推断高分辨率信息。

Method: 采用了四种生成扩散建模方法：两种基于预训练无条件模型的引导方法（SDEdit和DPS），以及两种需要配对数据训练的条件方法（vanilla变体和分类器自由引导）。

Result: 结果显示，SDEdit生成非物理场，DPS能以较低计算成本生成合理重建但平滑了精细特征；条件方法能重建缺失的精细特征并保持统计一致性。

Conclusion: 研究揭示了扩散模型在实现难度、保真度和一致性之间的权衡，为地球物理反问题的实际应用提供了指导。
...
### [418] [A network-theoretic approach for characterizing Mack-mode instability in high-speed boundary layers](https://arxiv.org/abs/2507.00370)
*Sai Prasad Mohanty,Nikhil Khobragade,Gaurav Chopra,Aswathi Krishna,R. I. Sujith,Subrahmanyam Duvvuri*

Main category: physics.flu-dyn

TL;DR: 本文提出了一种基于网络理论的方法，用于分析高速纹影数据中的Mack模式不稳定性特征，适用于间歇性波包的分析。


<details>
  <summary>Details</summary>
Motivation: 传统傅里叶技术不适用于分析间歇性波包，网络分析提供了一种更合适的框架。

Method: 应用时变空间邻近网络技术，通过网络拓扑中的连通分量揭示不稳定性波包的相位线和流动状态。

Result: 网络组件的方向角可作为识别Mack模式不稳定性的指标，并用于表征波包的波长和传播速度。

Conclusion: 网络分析为理解间歇性及其在层流到湍流过渡中的作用提供了有力框架。
...
### [419] [Nonlinear projection-based model order reduction with machine learning regression for closure error modeling in the latent space](https://arxiv.org/abs/2507.00634)
*S. Ares de Parga,Radek Tezaur,Carlos G. Hernández,Charbel Farhat*

Main category: physics.flu-dyn

TL;DR: 提出了一种基于高斯过程回归和径向基函数插值的新型非线性投影降阶方法，显著提升了效率和可解释性。


<details>
  <summary>Details</summary>
Motivation: 传统深度人工神经网络在投影降阶中存在可解释性差和需要大量训练数据的问题，需要更高效且可解释的方法。

Method: 采用高斯过程回归（GPR）和径向基函数（RBF）插值在潜在空间中对闭合误差进行建模。

Result: 在二维参数化无粘性Burgers问题和三维Ahmed车身湍流模拟中，新方法在保持精度的同时显著提升了效率和可解释性。

Conclusion: 该方法为非线性投影降阶提供了更高效、可解释的解决方案，扩展了其应用范围。
...
### [420] [Minimum-enstrophy and maximum-entropy equilibrium states in two-dimensional topographic turbulence](https://arxiv.org/abs/2507.00691)
*Jiyang He,Yan Wang*

Main category: physics.flu-dyn

TL;DR: 论文提出了一种结合线性关系和“sinh”关系的模型，成功描述了二维地形湍流中的最终状态，揭示了两种平衡态的共存。


<details>
  <summary>Details</summary>
Motivation: 由于现有最小涡度平衡态模型无法完全描述二维地形湍流中的最终状态，尤其是孤立涡旋的存在，作者受到启发，提出了新的模型。

Method: 论文提出了一种结合线性PV-流函数关系和“sinh”关系的模型，用于描述二维地形湍流中的孤立涡旋和背景流。通过数值模拟验证了模型的有效性。

Result: 模型在两种简单地形配置的数值模拟中表现出良好的吻合性，首次正确描述了最终流结构并揭示了两种平衡态的共存。

Conclusion: 该论文通过提出一个结合线性关系和“sinh”关系的模型，成功描述了二维地形湍流中的最终状态，揭示了两种平衡态的共存现象。
...
### [421] [Aerodynamic consequences of wing damage in dragonflies](https://arxiv.org/abs/2507.00713)
*Peng Yu,Ramiro Godoy-Diana,Benjamin Thiria,Dmitry Kolomenskiy,Thomas Engels*

Main category: physics.flu-dyn

TL;DR: CFD simulations show dragonfly wing damage reduces aerodynamic performance by altering flow fields and vortex structures, with forewing damage affecting hindwing performance.


<details>
  <summary>Details</summary>
Motivation: To understand how wing damage affects the aerodynamic performance of dragonflies, particularly the interaction between fore- and hindwings.

Method: CFD simulations were conducted on a series of damaged dragonfly fore-/hindwing models, comparing flow fields and aerodynamic forces with intact wings.

Result: Wing damage modifies vortex structures and flow fields, causing a drop in aerodynamic force production. Forewing damage significantly impacts hindwing performance due to wing-wing interaction.

Conclusion: The study demonstrates that wing damage in dragonflies not only reduces wing area but also alters vortex structures and flow fields, leading to a decline in aerodynamic performance. The interaction between fore- and hindwings exacerbates these effects when the forewing is damaged.
...
### [422] [A simplified unified wave-particle method for diatomic gases with rotational and vibrational non-equilibrium](https://arxiv.org/abs/2507.00720)
*Sirui Yang,Chengwen Zhong,Ningchao Ding,Junzhe Cao,He Zhang,Congshan Zhuo,Sha Liu*

Main category: physics.flu-dyn

TL;DR: 该研究提出了一种适用于多尺度流动的SUWP方法，结合了QMC机制和三温度模型，计算效率高且准确。


<details>
  <summary>Details</summary>
Motivation: 由于高超声速流动中存在多尺度流动和非平衡效应，需要一种能够准确模拟这些现象的数值方法。

Method: 研究开发了一种基于QMC机制的简化统一波粒（SUWP）方法，结合了三温度模型和无碰撞DSMC求解器。

Result: SUWP方法在多个基准测试中表现出优于DSMC和确定性方法的计算效率，同时保持准确性。

Conclusion: 该研究提出的SUWP方法在计算效率和准确性方面均表现出色，适用于解决多尺度流动问题。
...
### [423] [Insight into the combustion dynamics of ITA-driven swirl flames](https://arxiv.org/abs/2507.00764)
*SK Thirumalaikumaran,Balasundaram Mohan,Saptarshi Basu*

Main category: physics.flu-dyn

TL;DR: Study examines ITA-driven combustion instability in methane and methane-hydrogen mixtures, finding larger fluctuations for the latter. A model validates ITA mechanism, and vortex dynamics are analyzed.


<details>
  <summary>Details</summary>
Motivation: To understand the flame, flow, and acoustic coupling in ITA-driven combustion instability, particularly comparing pure methane and methane-hydrogen mixtures, and to develop a model to predict such instabilities.

Method: The research involves experimental measurements of acoustic pressure, chemiluminescence images, particle image velocimetry, and exhaust gas temperature in a model combustor. A low-order network model with an $n-\tau$ flame response is developed to analyze the instability.

Result: Non-monotonic variations in acoustic pressure amplitude are observed for both fuels, with methane-hydrogen showing larger fluctuations. The instability frequency increases linearly with airflow, confirming ITA-driven instability. Periodic vortex shedding and its interaction with the CRZ are identified during large amplitude oscillations.

Conclusion: The study confirms that Intrinsic ThermoAcoustic (ITA) driven combustion instability is observed in both pure methane and methane-hydrogen mixtures, with the latter showing a wider operating envelope and larger acoustic fluctuations. The developed low-order network model successfully reproduces the instability frequency, validating the ITA mechanism.
...
### [424] [Evaporation of sessile drops on a heated superhydrophobic substrate](https://arxiv.org/abs/2507.00774)
*Sivanandan Kavuri,Chander Shekhar Sharma,George Karapetsas,Kirti Chandra Sahu*

Main category: physics.flu-dyn

TL;DR: 研究了微纳米纹理超疏水铝基底上水滴的蒸发动力学，发现双滴系统因蒸汽屏蔽效应蒸发更慢，且温度影响蒸发模式。


<details>
  <summary>Details</summary>
Motivation: 探究超疏水基底上水滴的蒸发行为，特别是在双滴系统中的相互作用及温度对蒸发动力学的影响。

Method: 使用阴影成像技术观察水滴蒸发行为，比较孤立水滴与双滴系统的蒸发模式，并结合理论模型分析。

Result: 双滴系统因蒸汽屏蔽效应蒸发更慢，且蒸发模式随温度变化；高温下需综合模型，室温下仅扩散模型即可描述。

Conclusion: 蒸汽屏蔽效应和温度显著影响水滴蒸发行为，理论模型需考虑多种因素以准确描述不同条件下的蒸发动力学。
...
### [425] [Preliminary analysis of the annual component of the polar motion over 180-year data interval](https://arxiv.org/abs/2507.00197)
...
### [426] [Geological Everything Model 3D: A Promptable Foundation Model for Unified and Zero-Shot Subsurface Understanding](https://arxiv.org/abs/2507.00419)
...
### [427] [Preliminary analysis of the annual component of the polar motion over 180-year data interval](https://arxiv.org/abs/2507.00197)
*Natalia Miller,Zinovy Malkin*

Main category: physics.geo-ph

TL;DR: 论文研究了地球极移中年度分量的变化，发现振幅和相位在180年间单调增加，并与南北半球温差相关。


<details>
  <summary>Details</summary>
Motivation: 研究地球极移中年度分量的变化，以了解其长期趋势及其与气候因素的关系。

Method: 使用一维和多维奇异谱分析从IERS和Pulkovo纬度变化序列中提取年度信号，并用希尔伯特变换计算振幅和相位变化。

Result: 发现振幅从≈60mas增加到≈90mas，相位偏移≈45°，且与南北半球温差相关。

Conclusion: 年度分量的变化可能与气候因素有关，为进一步研究提供了方向。
...
### [428] [Geological Everything Model 3D: A Promptable Foundation Model for Unified and Zero-Shot Subsurface Understanding](https://arxiv.org/abs/2507.00419)
*Yimin Dou,Xinming Wu,Nathan L Bangs,Harpreet Singh Sethi,Jintao Li,Hang Gao,Zhixiang Guo*

Main category: physics.geo-ph

TL;DR: GEM 是一个统一的生成模型，通过提示条件推理实现跨任务零样本泛化，适用于多种地下分析任务。


<details>
  <summary>Details</summary>
Motivation: 为了解决地下分析任务中的碎片化问题，提出一个统一的模型，能够处理多种任务和数据源。

Method: GEM 采用两阶段训练过程，结合自监督表示学习和对抗性微调，利用混合提示和标签进行训练。

Result: GEM 在多种任务中展示了广泛适用性，包括火星雷达地层分析、俯冲带结构解释等。

Conclusion: GEM 提供了一个统一的生成架构，通过提示条件推理和潜在结构框架，实现了跨任务的零样本泛化，为可扩展的地球物理AI奠定了基础。
...
### [429] [Nine circles of elastic brittle fracture: A series of challenge problems to assess fracture models](https://arxiv.org/abs/2507.00266)
...
### [430] [Nine circles of elastic brittle fracture: A series of challenge problems to assess fracture models](https://arxiv.org/abs/2507.00266)
*Farhad Kamarei,Bo Zheng,John E. Dolbow,Oscar Lopez-Pamies*

Main category: physics.comp-ph

TL;DR: 本文提出了一种通过九个挑战问题来验证计算断裂模型的方法，旨在确保模型能够准确描述断裂的成核和扩展。


<details>
  <summary>Details</summary>
Motivation: 现有计算断裂模型往往只关注特定方面，忽略了其他已确立的因素，导致模型在一般条件下可能预测错误或非物理行为。

Method: 提出九个挑战问题，要求任何计算断裂模型必须能够处理这些问题，以验证其普适性。问题设计基于实验可行性和明确的分析。

Result: 通过两个相场断裂模型解决了这些挑战问题，展示了方法的有效性。

Conclusion: 提出的挑战问题为验证计算断裂模型的普适性提供了有效方法，有助于推动断裂模拟领域的发展。
